  ...
  extra.porcentaje = function (r) {
    ...
    if (directo) {
      return {
        guia: G({
          ...
          pasos: [
            { seccion: 'Paso 1: que es un porcentaje',
              queHacemos: 'Entendemos que significa el simbolo %.',
              paraQue: 'Por ciento es literalmente "de cada cien": ' + pct + '% es la fraccion ' + pct + '/100.',
              queda: pct + '/100 de ' + base,
            ...
            { seccion: 'Paso 2: a decimal',
              queHacemos: 'Convertimos el porcentaje a decimal.',
              paraQue: 'Dividir entre 100 es correr el punto dos lugares a la izquierda.',
              queda: (pct / 100) + ' &middot; ' + base,
            ...
            { seccion: 'Paso 3: multiplicar',
              queHacemos: 'Multiplicamos ese decimal por el total.',
              paraQue: 'Para obtener la parte que nos piden.',
              queda: F.n(base * pct / 100, 4),
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: decidir la division',
            queHacemos: 'Decidimos cual numero va arriba y cual abajo.',
            paraQue: 'Queremos saber que tanto del total es esa cantidad, asi que la parte va arriba.',
            queda: F.n(parte, 2) + ' &divide; ' + base,
          ...
          { seccion: 'Paso 2: dividir',
            ...
            paraQue: 'Sale un numero entre 0 y 1: la fraccion del total.',
            queda: (parte / base) + ' (todavia no es %)',
          ...
          { seccion: 'Paso 3: a porcentaje',
            ...
            paraQue: 'Para pasar del decimal al porcentaje.',
            queda: pct + '%',
  ...
  extra.escala = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: leer la escala',
            queHacemos: 'Entendemos que dice la escala.',
            paraQue: 'La escala no trae unidades: si mides en centimetros, el resultado sale en centimetros.',
            queda: cm + ' &times; ' + escala + ' cm',
          ...
          { seccion: 'Paso 2: pasar a la realidad',
            queHacemos: 'Multiplicamos la medida del mapa por el numero de la escala.',
            paraQue: 'Cada centimetro del mapa vale ' + escala + ' centimetros de verdad.',
            queda: F.n(cm * escala) + ' cm',
          ...
          { seccion: 'Paso 3: convertir unidades',
            queHacemos: 'Pasamos de centimetros a metros.',
            paraQue: 'Porque el problema pide metros, y 100 cm son 1 m.',
            queda: F.n(metros, 2) + ' m',
  ...
  extra.compuesta = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: ver que se conserva',
            queHacemos: 'Identificamos que cantidad es la misma en las dos situaciones.',
            paraQue: 'Con dos cosas cambiando a la vez, pelearse con proporciones enreda. Pensar en el trabajo total lo vuelve facil.',
            queda: 'el trabajo total no cambia',
          ...
          { seccion: 'Paso 2: medir el trabajo',
            queHacemos: 'Multiplicamos trabajadores por horas por dias.',
            paraQue: 'Eso mide la obra en horas-trabajador, y ese numero vale siempre lo mismo.',
            queda: trabajo + ' horas-trabajador',
          ...
          { seccion: 'Paso 3: el ritmo nuevo',
            queHacemos: 'Calculamos cuanto se avanza cada dia con las condiciones nuevas.',
            paraQue: 'Para saber en cuantos dias se cubre el trabajo total.',
            queda: (o2 * h2) + ' horas-trabajador por dia',
          ...
          { seccion: 'Paso 4: los dias',
            queHacemos: 'Dividimos el trabajo entre el ritmo diario.',
            paraQue: 'Para obtener los dias que tardan.',
            queda: F.n(d2, 4) + ' dias',
      ...
      if (dif === 'facil') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: multiplicar en cruz',
                queHacemos: 'Multiplicamos en diagonal: arriba de una por abajo de la otra.',
                paraQue: 'Si dos fracciones valen lo mismo, sus productos cruzados son iguales. Eso convierte la proporcion en una ecuacion sencilla.',
                queda: a + ' &middot; ' + d + ' = ' + b + 'x',
              ...
              { seccion: 'Paso 2: operar',
                queHacemos: 'Resolvemos la multiplicacion del lado que no tiene incognita.',
                paraQue: 'Para dejar la ecuacion con un solo numero de ese lado.',
                queda: (a * d) + ' = ' + b + 'x',
              ...
              { seccion: 'Paso 3: despejar',
                queHacemos: 'Pasamos el coeficiente dividiendo.',
                paraQue: 'Para dejar sola a la x.',
                queda: 'x = ' + c,
        ...
        if (t === 'inversa') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: directa o inversa',
                queHacemos: 'Decidimos si la proporcion es directa o inversa.',
                paraQue: 'Es lo primero que hay que resolver: en la directa se divide y en la inversa se multiplica. Confundirlas cambia todo el ejercicio.',
                queda: 'inversa: el PRODUCTO es constante',
              ...
              { seccion: 'Paso 2: la constante',
                queHacemos: 'Multiplicamos los datos completos.',
                paraQue: 'En una inversa lo que no cambia es el producto: aqui es el trabajo total, en dias-trabajador.',
                queda: total + ' dias-trabajador',
              ...
              { seccion: 'Paso 3: repartir',
                queHacemos: 'Dividimos el trabajo entre los trabajadores nuevos.',
                paraQue: 'Para saber cuantos dias tardan.',
                queda: F.n(total / o2, 2) + ' dias',
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: despejar k',
                queHacemos: 'Despejamos la constante de la relacion y = kx.',
                paraQue: 'La x esta multiplicando, asi que pasa dividiendo.',
                queda: 'k = y / x',
              ...
              { seccion: 'Paso 2: calcular k',
                queHacemos: 'Calculamos la constante con el par de datos que nos dan.',
                paraQue: 'Ese k no cambia nunca en el problema: sirve para cualquier otro par.',
                queda: 'y = ' + kk + 'x',
              ...
              { seccion: 'Paso 3: usar la relacion',
                queHacemos: 'Sustituimos el nuevo valor de x.',
                paraQue: 'Para obtener la y que nos piden.',
                queda: 'k = ' + kk + ', y = ' + (kk * x2),
        ...
        if (t2 === 'lineal') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: la pendiente',
                queHacemos: 'Calculamos cuanto subio (o bajo) la y entre los dos puntos.',
                paraQue: 'La pendiente es cuanto sube la y por cada unidad que avanza la x. Primero el de arriba de esa fraccion.',
                queda: 'm = ' + (y2 - y1) + ' &divide; ?',
                ...
                despues: '' },
              { seccion: 'Paso 1: la pendiente',
                queHacemos: 'Ahora cuanto avanzo la x.',
                paraQue: 'Importante: el mismo ORDEN que arriba. Si arriba pusiste el segundo menos el primero, abajo igual.',
                queda: 'm = ' + (y2 - y1) + ' &divide; ' + (b - a),
              ...
              { seccion: 'Paso 1: la pendiente',
                queHacemos: 'Dividimos para obtener la pendiente.',
                paraQue: 'Ya tenemos la inclinacion de la recta.',
                queda: 'y = ' + m + 'x + b',
              ...
              { seccion: 'Paso 2: la ordenada b',
                queHacemos: 'Sustituimos uno de los puntos para despejar la b.',
                paraQue: 'La pendiente sola no basta: hay infinitas rectas con esa inclinacion. La b dice por donde pasa.',
                queda: 'y = ' + F.poli([m, bb], 'x'),
              ...
              { seccion: 'Paso 3: evaluar',
                queHacemos: 'Usamos la ecuacion para calcular la y que piden.',
                paraQue: 'Con la recta completa ya se puede predecir cualquier valor.',
                queda: 'm = ' + m + ', b = ' + bb + ', y = ' + (m * x0 + bb),
                pregunta: 'Ya con la ecuacion, calcula y cuando x = ' + x0 + '.',
                resp: R.numero(m * x0 + bb, { dec: 3 }),
                pista: m + ' &middot; ' + x0 + ' + (' + bb + ').',
                despues: '' },
              { seccion: 'Paso 3: evaluar',
                queHacemos: 'Escribimos las tres respuestas.',
                paraQue: 'Para cerrar el ejercicio.',
                queda: 'm = ' + m + ', b = ' + bb + ', y = ' + (m * x0 + bb),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: contar las partes',
                queHacemos: 'Sumamos los numeros de la proporcion.',
                paraQue: 'El dinero se corta en pedacitos iguales, y esos numeros dicen cuantos le tocan a cada quien. Primero hay que saber cuantos hay en total.',
                queda: (p1 + p2 + p3) + ' partes',
              ...
              { seccion: 'Paso 2: el valor de una parte',
                queHacemos: 'Dividimos el total entre el numero de partes.',
                paraQue: 'Este es el numero clave: con el se resuelve todo lo demas.',
                queda: 'cada parte vale ' + u,
              ...
              { seccion: 'Paso 3: repartir',
                queHacemos: 'Multiplicamos las partes de cada quien por el valor de una parte.',
                paraQue: 'Para saber cuanto le toca a cada persona.',
                queda: (p1 * u) + ', ?, ?',
              ...
              { seccion: 'Paso 3: repartir',
                queHacemos: 'Calculamos las tres y las escribimos.',
                paraQue: 'Comprobacion: las tres deben sumar exactamente el total.',
                queda: (p1 * u) + ', ' + (p2 * u) + ', ' + (p3 * u),
