  ...
  extra.propiedadesBasicas = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: el log de 1',
            queHacemos: 'Buscamos a que exponente elevar la base para obtener 1.',
            paraQue: 'Cualquier numero elevado a 0 da 1. Por eso el log de 1 SIEMPRE vale 0, sea cual sea la base.',
            queda: '0 + ? + ?',
          ...
          { seccion: 'Paso 2: el log de la propia base',
            queHacemos: 'Ahora con la base consigo misma.',
            paraQue: 'La base elevada a 1 es ella misma, asi que log<sub>b</sub>(b) = 1 siempre.',
            queda: '0 + 1 + ?',
          ...
          { seccion: 'Paso 3: el log de una potencia de la base',
            queHacemos: 'Y con una potencia de la propia base.',
            paraQue: 'El logaritmo devuelve el exponente tal cual: log<sub>b</sub>(b<sup>k</sup>) = k. Se deshacen entre ellos.',
            queda: '0 + 1 + ' + k,
          ...
          { seccion: 'Paso 4: sumar',
            queHacemos: 'Sumamos los tres valores.',
            paraQue: 'Los tres son casos especiales que se resuelven sin calculadora.',
            queda: 'total = ' + val,
  ...
  extra.expandir = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: romper el producto y el cociente',
            queHacemos: 'Separamos el logaritmo grande en varios chiquitos.',
            paraQue: 'Primera tanda: los productos se vuelven sumas y los cocientes, restas.',
            queda: 'log(x<sup>' + p + '</sup>) + log(y<sup>' + q + '</sup>) &minus; log(z<sup>' + s + '</sup>)',
          ...
          { seccion: 'Paso 2: bajar los exponentes',
            queHacemos: 'Bajamos el exponente de la x como coeficiente.',
            paraQue: 'Segunda tanda: lo que estaba arriba como exponente pasa al frente multiplicando.',
            queda: p + ' log x + ? log y + ? log z',
          ...
          { seccion: 'Paso 2: bajar los exponentes',
            ...
            paraQue: 'Cada exponente baja al frente de su propio logaritmo.',
            queda: p + ' log x + ' + q + ' log y + ? log z',
            pregunta: '&iquest;Y el coeficiente de log y?',
            resp: R.numero(q, { dec: 0 }),
            pista: 'El exponente de la y.',
            despues: '' },
          { seccion: 'Paso 2: bajar los exponentes',
            queHacemos: 'Y con la z, arrastrando el signo.',
            paraQue: 'La z venia del denominador, asi que su logaritmo iba RESTANDO. El coeficiente sale negativo.',
            queda: p + ' log x + ' + q + ' log y &minus; ' + s + ' log z',
          ...
          { seccion: 'Paso 3: escribir',
            queHacemos: 'Damos los tres coeficientes.',
      ...
      if (dif === 'facil') {
        ...
        if (t === 'evaluar') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: la definicion',
                queHacemos: 'Recordamos la equivalencia entre las dos formas.',
                paraQue: 'Logaritmo y potencia son la misma informacion escrita de dos maneras. Traducir entre ellas resuelve casi todo el tema.',
                queda: b + '<sup>?</sup> = x',
              ...
              { seccion: 'Paso 2: quien es quien',
                queHacemos: 'Identificamos quien hace de exponente.',
                paraQue: 'El VALOR del logaritmo es justo el exponente que buscabamos.',
                queda: b + '<sup>' + n + '</sup> = x',
              ...
              { seccion: 'Paso 3: calcular',
                queHacemos: 'Hacemos la potencia.',
                paraQue: 'Eso deja la forma exponencial completa, con el numero en vez de la x.',
                queda: b + '<sup>' + n + '</sup> = ' + x,
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: la base',
                queHacemos: 'Localizamos la base.',
                paraQue: 'Base, exponente y resultado cambian de lugar al traducir, pero no de papel.',
                queda: 'log<sub>' + b + '</sub>(?) = ?',
              ...
              { seccion: 'Paso 2: el exponente',
                queHacemos: 'Ahora el exponente.',
                paraQue: 'Es la pieza que va a cambiar de sitio.',
                queda: 'base ' + b + ',  exponente ' + n,
                pregunta: '&iquest;Y el exponente?',
                resp: R.numero(n, { dec: 0 }),
                pista: 'El numerito de arriba.',
                despues: '' },
              { seccion: 'Paso 3: el intercambio',
                queHacemos: 'Vemos donde acaba el exponente.',
                paraQue: 'El exponente se convierte en el RESULTADO del logaritmo, y el resultado de la potencia pasa a ser el argumento.',
                queda: 'log<sub>' + b + '</sub>(' + x + ') = ?',
              ...
              { seccion: 'Paso 4: escribir',
                queHacemos: 'Damos el valor.',
                paraQue: 'Para cerrar la traduccion.',
        ...
        if (t2 === 'propiedades') {
          ...
          if (op === 'producto') {
            pasosPr = [
              { seccion: 'Paso 1: elegir la propiedad',
                queHacemos: 'Vemos que el argumento es un producto.',
                paraQue: 'El log de un producto se parte en una SUMA de logaritmos. Asi se usan los datos que si conocemos.',
                queda: F.n(la, 4) + ' + ' + F.n(lb, 4),
              ...
              { seccion: 'Paso 2: sustituir',
                queHacemos: 'Sumamos los dos valores dados.',
                paraQue: 'No hace falta calculadora para el logaritmo: solo combinar los datos.',
                queda: F.n(valor, 4),
            ...
            pasosPr = [
              { seccion: 'Paso 1: elegir la propiedad',
                queHacemos: 'Vemos que el argumento es un cociente.',
                paraQue: 'El log de un cociente se parte en una RESTA de logaritmos.',
                queda: F.n(la, 4) + ' &minus; ' + F.n(lb, 4),
              ...
              { seccion: 'Paso 2: sustituir',
                queHacemos: 'Restamos los dos valores dados.',
                paraQue: 'Ojo con el orden: el de arriba menos el de abajo.',
                queda: F.n(valor, 4),
            ...
            pasosPr = [
              { seccion: 'Paso 1: elegir la propiedad',
                queHacemos: 'Vemos que el argumento es una potencia.',
                paraQue: 'El exponente BAJA al frente multiplicando. Es la propiedad que mas se usa para resolver ecuaciones.',
                queda: n + ' &times; ' + F.n(la, 4),
              ...
              { seccion: 'Paso 2: multiplicar',
                queHacemos: 'Hacemos la multiplicacion.',
                paraQue: 'Para cerrar el ejercicio.',
                queda: F.n(valor, 4),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: subir los coeficientes',
                queHacemos: 'Convertimos cada coeficiente en exponente del argumento.',
                paraQue: 'Es el camino inverso de expandir, y en orden inverso: primero suben los coeficientes, al final se juntan sumas y restas.',
                queda: 'log(' + X + '<sup>' + c1 + '</sup>) &minus; log(' + Y + '<sup>' + c2 + '</sup>)',
              ...
              { seccion: 'Paso 1: subir los coeficientes',
                queHacemos: 'Calculamos la primera potencia.',
                paraQue: 'Con el numero ya hecho el argumento queda limpio.',
                queda: 'log(' + Math.pow(X, c1) + ') &minus; log(' + Y + '<sup>' + c2 + '</sup>)',
                ...
                despues: '' },
              { seccion: 'Paso 1: subir los coeficientes',
                queHacemos: 'Y la segunda.',
                paraQue: 'Ya con los dos argumentos listos se pueden juntar.',
                queda: 'log(' + Math.pow(X, c1) + ') &minus; log(' + Math.pow(Y, c2) + ')',
              ...
              { seccion: 'Paso 2: juntar en uno solo',
                queHacemos: 'Convertimos la resta en un cociente.',
                paraQue: 'Suma de logs = log del producto; resta de logs = log del cociente.',
                queda: 'log(' + Math.pow(X, c1) + ' &divide; ' + Math.pow(Y, c2) + ')',
                ...
                despues: '' },
              { seccion: 'Paso 3: el argumento final',
                queHacemos: 'Hacemos la division.',
                paraQue: 'Ese numero es el argumento del logaritmo condensado.',
                queda: 'log(' + F.n(res, 4) + ')',
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: quitar el logaritmo',
                queHacemos: 'Pasamos la ecuacion a forma exponencial.',
                paraQue: 'Un logaritmo no es un factor que multiplica: es una operacion. Se deshace con su inversa, la potencia.',
                queda: 'x + ' + k + ' = ' + b + '<sup>' + n + '</sup>',
              ...
              { seccion: 'Paso 2: calcular la potencia',
                queHacemos: 'Hacemos la potencia.',
                paraQue: 'La ecuacion queda de primer grado: ya es facil.',
                queda: 'x + ' + k + ' = ' + Math.pow(b, n),
                pregunta: 'Calcula ' + b + '<sup>' + n + '</sup>',
              ...
              { seccion: 'Paso 3: despejar',
                queHacemos: 'Pasamos el numero restando.',
                paraQue: 'Despeje normal de primer grado.',
                queda: 'x = ' + sol0,
              ...
              { seccion: 'Paso 4: comprobar',
                queHacemos: 'Verificamos que el argumento salga positivo.',
                paraQue: 'El log de un numero negativo o de cero no existe. A veces el despeje da soluciones que hay que descartar por eso.',
                queda: 'x = ' + sol0 + '  (valida)',
        ...
        if (t3 === 'exponencial') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: bajar el exponente',
                queHacemos: 'Aplicamos logaritmo a los dos lados.',
                paraQue: 'Es justo para lo que sirve la propiedad log(A<sup>n</sup>) = n log A: sacar la incognita del exponente.',
                queda: 'x log(' + b + ') = log(' + obj + ')',
              ...
              { seccion: 'Paso 2: que base usar',
                queHacemos: 'Elegimos la base del logaritmo.',
                paraQue: 'Da igual cual uses mientras sea la MISMA en los dos lados: el cociente sale el mismo.',
                queda: 'x = log(' + obj + ') &divide; log(' + b + ')',
              ...
              { seccion: 'Paso 3: dividir',
                queHacemos: 'Hacemos la division.',
                paraQue: 'Comprobacion: eleva la base a ese resultado y debe darte el numero del enunciado.',
                queda: 'x = ' + F.n(sol1, 4),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: por que hace falta',
                queHacemos: 'Vemos por que no se puede calcular directo.',
                paraQue: 'La calculadora solo trae log (base 10) y ln (base e). Para cualquier otra base hay que dar un rodeo.',
                queda: 'log<sub>' + b + '</sub>(' + arg + ') = ?',
              ...
              { seccion: 'Paso 2: la formula',
                queHacemos: 'Escribimos el cociente de dos logaritmos de la base que si tenemos.',
                paraQue: 'Arriba el argumento, abajo la base. Invertirlos es el error tipico.',
                queda: 'ln(' + arg + ') &divide; ln(' + b + ')',
              ...
              { seccion: 'Paso 3: el numerador',
                queHacemos: 'Calculamos el logaritmo del argumento.',
                paraQue: 'Es la pieza de arriba del cociente.',
                queda: F.n(Math.log(arg), 4) + ' &divide; ' + F.n(Math.log(b), 4),
              ...
              { seccion: 'Paso 4: dividir',
                queHacemos: 'Dividimos entre el logaritmo de la base.',
                paraQue: 'Comprobacion: eleva la base a ese resultado y debe darte el argumento.',
                queda: 'log<sub>' + b + '</sub>(' + arg + ') = ' + F.n(val, 4),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: plantear el modelo',
                queHacemos: 'Escribimos la formula del interes compuesto.',
                paraQue: 'El tiempo esta en el EXPONENTE, y por eso el dinero crece cada vez mas rapido.',
                queda: meta + ' = ' + C + '(1 + ' + (tasa / 100) + ')<sup>t</sup>',
              ...
              { seccion: 'Paso 2: aislar la potencia',
                queHacemos: 'Dividimos entre el capital inicial.',
                paraQue: 'Asi queda la potencia sola de un lado, lista para aplicarle el logaritmo.',
                queda: (meta / C) + ' = (1 + ' + (tasa / 100) + ')<sup>t</sup>',
              ...
              { seccion: 'Paso 3: bajar la t',
                queHacemos: 'Aplicamos logaritmo a los dos lados.',
                paraQue: 'El exponente baja al frente multiplicando, y ahi ya se puede despejar.',
                queda: 't = log(' + (meta / C) + ') &divide; log(' + (1 + tasa / 100) + ')',
              ...
              { seccion: 'Paso 4: calcular t',
                queHacemos: 'Hacemos la division.',
                paraQue: 'El resultado son anios, y casi nunca sale entero.',
                queda: 't = ' + F.n(anios, 4) + ' anios',
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: separar el producto',
                queHacemos: 'Partimos el logaritmo del producto en una suma.',
                paraQue: 'log(10<sup>&minus;n</sup>) = &minus;n directamente, porque en base 10 el log de una potencia de 10 es su exponente.',
                queda: 'log(' + mant + ') &minus; ' + expo,
              ...
              { seccion: 'Paso 2: el logaritmo de la mantisa',
                queHacemos: 'Calculamos el logaritmo del primer factor.',
                paraQue: 'Como esta entre 1 y 10, el resultado queda entre 0 y 1.',
                queda: 'log[H<sup>+</sup>] = ' + F.n(Math.log(conc) / Math.LN10, 4),
              ...
              { seccion: 'Paso 3: cambiar el signo',
                queHacemos: 'Le cambiamos el signo.',
                paraQue: 'Ese menos de la definicion esta justo para que el pH salga positivo, ya que las concentraciones son menores que 1.',
                queda: 'pH = ' + F.n(pH, 4),
              ...
              { seccion: 'Paso 4: interpretar',
                queHacemos: 'Comparamos el pH con 7.',
                paraQue: 'Como la escala es logaritmica, un pH de 4 es DIEZ veces mas acido que uno de 5, no un poco mas.',
                queda: 'pH ' + F.n(pH, 4) + ':  ' + (pH < 7 ? 'acida' : 'basica'),
