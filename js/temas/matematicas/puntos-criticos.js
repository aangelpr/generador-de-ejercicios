  ...
  extra.concavidad = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { rotulo: 'Quien manda',
            seccion: 'Paso 1: que derivada toca',
            queHacemos: 'Elegimos la derivada que decide la concavidad.',
            paraQue: 'La primera dice si sube o baja; la SEGUNDA dice hacia donde abre la curva.',
          ...
          { rotulo: 'Primera derivada',
            ...
            paraQue: 'Es el paso intermedio: hay que pasar por ella para llegar a la segunda.',
            queda: 'f&prime;(x) = ' + P.texto(P.derivada(p)),
          ...
          { rotulo: 'Segunda derivada',
            ...
            queHacemos: 'Volvemos a derivar.',
            paraQue: 'Su signo es el que dice si la curva abre hacia arriba o hacia abajo.',
          ...
          { rotulo: 'x del cambio',
            seccion: 'Paso 4: donde cambia',
            queHacemos: 'Resolvemos f&Prime;(x) = 0.',
            paraQue: 'Ahi es donde la concavidad se da la vuelta.',
            queda: 'cambia en x = ' + F.n(x0, 4),
          ...
          { rotulo: 'A la derecha',
            seccion: 'Paso 5: hacia que lado abre',
            queHacemos: 'Miramos el signo de f&Prime; a la derecha del corte.',
            paraQue: 'Concava hacia arriba es forma de taza; hacia abajo, forma de paraguas.',
            queda: 'x = ' + F.n(x0, 4) + ';  a la derecha abre hacia ' + (arribaDespues ? 'arriba' : 'abajo'),
          ...
          { rotulo: 'Respuesta',
            ...
            queHacemos: 'Damos el punto y el sentido.',
            paraQue: 'Para cerrar el ejercicio.',
            queda: 'x = ' + F.n(x0, 4) + ',  hacia ' + (arribaDespues ? 'arriba' : 'abajo'),
      ...
      if (dif === 'facil') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Que es un punto critico',
                seccion: 'Paso 1: que es un punto critico',
                queHacemos: 'Recordamos donde estan los puntos criticos.',
                paraQue: 'Es donde la curva se APLANA: ni sube ni baja, asi que su pendiente vale 0.',
                queda: 'resolver f&prime;(x) = 0',
              ...
              { rotulo: 'La derivada',
                ...
                queHacemos: 'Derivamos la cubica.',
                paraQue: 'La derivada de una cubica es una cuadratica: por eso salen DOS puntos criticos.',
                queda: P.texto(d) + ' = 0',
                pregunta: 'Deriva f(x).',
              ...
              { rotulo: 'Simplificar',
                ...
                queHacemos: 'Dividimos los tres coeficientes entre su factor comun.',
                paraQue: 'Al estar igualada a cero, dividir no cambia las soluciones y deja numeros mucho mas comodos.',
                queda: 'x&sup2; ' + (-(cb.lo + cb.hi) < 0 ? '&minus; ' + (cb.lo + cb.hi) : '+ ' + (-(cb.lo + cb.hi))) + 'x ' + (cb.lo * cb.hi < 0 ? '&minus; ' + (-(cb.lo * cb.hi)) : '+ ' + (cb.lo * cb.hi)) + ' = 0',
              ...
              { rotulo: 'Puntos criticos',
                seccion: 'Paso 4: resolver',
                queHacemos: 'Resolvemos la cuadratica.',
                paraQue: 'Esos dos valores son los puntos criticos: uno sera maximo local y el otro minimo local.',
                queda: 'x = ' + cb.lo + ',  x = ' + cb.hi,
        ...
        if (t === 'clasificaCuad') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'x critico',
                seccion: 'Paso 1: el punto critico',
                queHacemos: 'Derivamos, igualamos a cero y despejamos.',
                paraQue: 'Encontrarlo es facil; lo nuevo viene despues, al clasificarlo.',
                queda: 'x = ' + F.n(x0, 4) + ';  falta la altura y el tipo',
              ...
              { rotulo: 'f(x) ahi',
                seccion: 'Paso 2: la altura',
                queHacemos: 'Sustituimos en la funcion original.',
                paraQue: 'En la ORIGINAL, no en la derivada. La derivada ahi vale 0 por definicion.',
                queda: '(' + F.n(x0, 4) + ', ' + F.n(P.evalua([a, b, c], x0), 4) + ');  falta el tipo',
                ...
                despues: '' },
              { rotulo: 'Segunda derivada',
                seccion: 'Paso 3: la segunda derivada',
                queHacemos: 'Derivamos una segunda vez.',
                paraQue: 'En una cuadratica la segunda derivada es una constante: el mismo signo en todas partes.',
                queda: 'f&Prime; = ' + (2 * a),
              ...
              { rotulo: 'Tipo',
                ...
                queHacemos: 'Aplicamos el criterio de la segunda derivada.',
                paraQue: 'Positiva: abre hacia arriba, el critico es un minimo. Negativa: abre hacia abajo, es un maximo.',
                queda: '(' + F.n(x0, 4) + ', ' + F.n(P.evalua([a, b, c], x0), 4) + '),  ' + (a > 0 ? 'minimo' : 'maximo'),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Puntos criticos',
                seccion: 'Paso 1: los dos criticos',
                queHacemos: 'Derivamos, igualamos a cero y resolvemos.',
                paraQue: 'En una cubica los dos criticos son de DISTINTO tipo: uno es maximo local y el otro minimo local.',
                queda: 'x = ' + cb2.lo + ' y x = ' + cb2.hi + ';  falta clasificar',
              ...
              { rotulo: 'Segunda derivada',
                seccion: 'Paso 2: la segunda derivada',
                queHacemos: 'Calculamos la segunda derivada.',
                paraQue: 'Aqui ya no es constante: hay que evaluarla en cada critico por separado.',
                queda: 'f&Prime;(x) = ' + P.texto(d2),
              ...
              { rotulo: 'f&Prime; en el menor',
                seccion: 'Paso 3: evaluar en el critico',
                queHacemos: 'Sustituimos el critico de la izquierda en la segunda derivada.',
                paraQue: 'Lo que importa no es el numero sino su SIGNO.',
                queda: 'f&Prime;(' + cb2.lo + ') = ' + F.n(P.evalua(d2, cb2.lo), 2),
              ...
              { rotulo: 'Clasificacion',
                seccion: 'Paso 4: clasificar',
                queHacemos: 'Traducimos el signo a maximo o minimo.',
                paraQue: 'Con a positiva la cubica sube, baja y vuelve a subir, asi que el de la izquierda es el maximo local.',
                queda: 'x = ' + cb2.lo + ':  ' + (P.evalua(d2, cb2.lo) < 0 ? 'maximo local' : 'minimo local'),
              ...
              { rotulo: 'Respuesta',
                seccion: 'Paso 5: escribir',
                queHacemos: 'Damos los dos criticos y el tipo del primero.',
                paraQue: 'Para cerrar el ejercicio.',
                queda: cb2.lo + ',  ' + cb2.hi + ',  el de la izquierda es ' + (P.evalua(d2, cb2.lo) < 0 ? 'maximo' : 'minimo'),
                pregunta: 'Escribe las tres respuestas.',
                resp: R.varios([
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Que es la inflexion',
                seccion: 'Paso 1: que es la inflexion',
                queHacemos: 'Aclaramos que es un punto de inflexion.',
                paraQue: 'No es un maximo ni un minimo: es donde la curva deja de abrir hacia un lado y empieza a abrir hacia el otro.',
                queda: 'resolver f&Prime;(x) = 0',
              ...
              { rotulo: 'Primera derivada',
                seccion: 'Paso 2: primera derivada',
                queHacemos: 'Derivamos una vez.',
                paraQue: 'Es el paso intermedio para llegar a la segunda.',
                queda: 'f&prime;(x) = ' + P.texto(P.derivada(p)),
                pregunta: 'Deriva una vez.',
                resp: R.expresion(P.expr(P.derivada(p)), { mostrar: P.texto(P.derivada(p)) }),
              ...
              { rotulo: 'Segunda derivada',
                seccion: 'Paso 3: segunda derivada',
                queHacemos: 'Derivamos otra vez.',
                paraQue: 'En una cubica la segunda derivada es una recta, asi que solo hay UN punto de inflexion.',
                queda: 'f&Prime;(x) = ' + P.texto(d2),
                pregunta: 'Deriva otra vez.',
                resp: R.expresion(P.expr(d2), { mostrar: P.texto(d2) }),
                pista: 'Deriva el resultado anterior: ' + P.texto(d2) + '.',
              ...
              { rotulo: 'Punto de inflexion',
                seccion: 'Paso 4: resolver',
                queHacemos: 'Igualamos la segunda derivada a cero.',
                paraQue: 'Ahi la curva cambia de "taza" a "paraguas" o al reves.',
                queda: 'inflexion en x = ' + F.n(x0, 4),
                pregunta: 'Iguala f&Prime;(x) = 0 y despeja x. (4 decimales)',
                resp: R.numero(x0, { dec: 4, tol: 0.01 }),
                pista: d2[0] + 'x ' + (d2[1] < 0 ? '&minus; ' + (-d2[1]) : '+ ' + d2[1]) + ' = 0.',
        ...
        if (t2 === 'extremosIntervalo') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Donde buscar',
                seccion: 'Paso 1: donde buscar',
                queHacemos: 'Decidimos que candidatos hay que revisar.',
                paraQue: 'Esta es la trampa clasica: el maximo absoluto puede estar en un EXTREMO del intervalo, donde la derivada no vale cero.',
                queda: 'candidatos: los criticos y los extremos ' + a + ' y ' + b,
              ...
              { rotulo: 'Puntos criticos',
                seccion: 'Paso 2: los criticos',
                queHacemos: 'Encontramos los puntos criticos.',
                paraQue: 'Son dos de los cuatro candidatos.',
                queda: 'candidatos: ' + candidatos.join(', '),
                pregunta: 'Deriva, iguala a cero y resuelve.<br>Escribe los dos valores separados por coma.',
              ...
              { rotulo: 'Cuantos candidatos',
                seccion: 'Paso 3: contar los candidatos',
                queHacemos: 'Juntamos criticos y extremos.',
                paraQue: 'Los cuatro se evaluan en la funcion; gana el mas alto y el mas bajo.',
                queda: 'candidatos: ' + candidatos.join(', '),
              ...
              { rotulo: 'Maximo absoluto',
                seccion: 'Paso 4: el maximo',
                queHacemos: 'Evaluamos los cuatro y nos quedamos con el mayor.',
                paraQue: 'Ese es el maximo absoluto del intervalo.',
                queda: 'maximo ' + F.n(maxV, 2) + ',  minimo ?',
              ...
              { rotulo: 'Minimo absoluto',
                seccion: 'Paso 5: el minimo',
                queHacemos: 'Ahora el mas bajo.',
                paraQue: 'Ese es el minimo absoluto.',
                queda: 'maximo ' + F.n(maxV, 2) + ',  minimo ' + F.n(minV, 2),
              ...
              { rotulo: 'Respuesta',
                seccion: 'Paso 6: escribir',
                queHacemos: 'Damos los dos extremos absolutos.',
                paraQue: 'Para cerrar el ejercicio.',
                queda: 'maximo ' + F.n(maxV, 2) + ',  minimo ' + F.n(minV, 2),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Puntos criticos',
                seccion: 'Paso 1: los criticos',
                queHacemos: 'Primera derivada igualada a cero.',
                paraQue: 'La PRIMERA derivada da los puntos criticos; la segunda dara la inflexion.',
                queda: 'criticos ' + cb4.lo + ' y ' + cb4.hi + ';  falta la inflexion',
              ...
              { rotulo: 'Inflexion',
                seccion: 'Paso 2: la inflexion',
                queHacemos: 'Segunda derivada igualada a cero.',
                paraQue: 'Dato bonito: la inflexion siempre cae justo a la mitad de los dos criticos.',
                queda: 'criticos ' + cb4.lo + ' y ' + cb4.hi + ',  inflexion ' + F.n(xinf, 4),
              ...
              { rotulo: 'Donde esta el maximo',
                seccion: 'Paso 3: cual es el maximo',
                queHacemos: 'Miramos el signo del coeficiente principal.',
                paraQue: 'Con a positiva la cubica sube, baja y sube: el maximo local es el critico MENOR. Con a negativa, al reves.',
                queda: 'maximo local en x = ' + xMax,
              ...
              { rotulo: 'Valor maximo local',
                seccion: 'Paso 4: el valor maximo',
                queHacemos: 'Sustituimos ese critico en la funcion original.',
                paraQue: 'Esa es la altura del maximo local.',
                queda: 'maximo local ' + F.n(P.evalua(p, xMax), 2),
              ...
              { rotulo: 'Respuesta',
                ...
                paraQue: 'Para cerrar el analisis.',
                queda: 'criticos ' + cb4.lo + ' y ' + cb4.hi + ',  inflexion ' + F.n(xinf, 4) + ',  maximo ' + F.n(P.evalua(p, xMax), 2),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'La restriccion',
                seccion: 'Paso 1: la restriccion',
                queHacemos: 'Despejamos un lado en funcion del otro.',
                paraQue: 'El truco de toda optimizacion: dejar todo en funcion de UNA sola variable.',
                queda: 'y = ' + (per / 2) + ' &minus; x',
              ...
              { rotulo: 'La funcion a maximizar',
                seccion: 'Paso 2: la funcion a maximizar',
                queHacemos: 'Escribimos el area como funcion de x.',
                paraQue: 'Queda una cuadratica con la x&sup2; negativa: abre hacia abajo, asi que tiene maximo.',
                queda: 'A(x) = &minus;x&sup2; + ' + (per / 2) + 'x',
              ...
              { rotulo: 'Derivar e igualar',
                seccion: 'Paso 3: derivar e igualar a cero',
                queHacemos: 'Buscamos el punto critico del area.',
                paraQue: 'Ahi el area deja de crecer y empieza a decrecer: es el maximo.',
                queda: 'x = ' + ladoOpt + ' m',
              ...
              { rotulo: 'Area maxima',
                seccion: 'Paso 4: el area maxima',
                queHacemos: 'Sustituimos ese lado en el area.',
                paraQue: 'Fijate en el resultado: los dos lados salen iguales. Con perimetro fijo, el CUADRADO siempre encierra mas area.',
                queda: 'lado ' + ladoOpt + ' m,  area ' + areaOpt + ' m&sup2;',
