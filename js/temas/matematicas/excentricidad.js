  ...
  extra.comparar = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: la elipse A',
            queHacemos: 'Calculamos la c de la primera elipse.',
            paraQue: 'A ojo no se puede comparar: hay elipses con numeros grandes casi redondas y otras con numeros chicos muy estiradas.',
            queda: 'c(A) = ' + F.n(cA, 4) + ';  e(A) = ?,  e(B) = ?',
          ...
          { seccion: 'Paso 1: la elipse A',
            ...
            paraQue: 'Eso es la excentricidad: cuanto se aleja de ser un circulo.',
            queda: 'e(A) = ' + F.n(e1, 4) + ',  e(B) = ?',
          ...
          { seccion: 'Paso 2: la elipse B',
            queHacemos: 'Repetimos todo con la segunda.',
            paraQue: 'Solo con las dos excentricidades en la mano se pueden comparar.',
            queda: 'e(A) = ' + F.n(e1, 4) + ',  e(B) = ' + F.n(e2, 4),
          ...
          { seccion: 'Paso 3: comparar',
            queHacemos: 'Vemos cual excentricidad es menor.',
            paraQue: 'Cuanto mas cerca de 0, mas redonda. La mas circular es la de excentricidad MENOR.',
            queda: 'mas circular: la ' + (e1 < e2 ? 'A' : 'B'),
          ...
          { seccion: 'Paso 4: escribir',
            queHacemos: 'Damos las dos excentricidades y cual es mas circular.',
            paraQue: 'Para cerrar el ejercicio.',
            queda: 'e(A) = ' + F.n(e1, 4) + ',  e(B) = ' + F.n(e2, 4) + ',  mas circular la ' + (e1 < e2 ? 'A' : 'B'),
      ...
      if (dif === 'facil') {
        ...
        if (t === 'elipseAC') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: la formula',
                queHacemos: 'Recordamos que e = c/a.',
                paraQue: 'Hay que tener claro que es cada letra: a es el semieje mayor y c la distancia del centro a un foco.',
                queda: 'e = ' + c + ' &divide; ' + a,
              ...
              { seccion: 'Paso 2: dividir',
                ...
                paraQue: 'Como c siempre es menor que a en una elipse, el resultado cae entre 0 y 1.',
                queda: 'e = ' + F.n(e, 4),
                pregunta: 'Calcula e = ' + c + ' &divide; ' + a + ' (4 decimales)',
                resp: R.numero(e, { dec: 4, tol: 0.01 }),
                pista: 'Division directa.',
                despues: '' },
              { seccion: 'Paso 3: interpretarlo',
                queHacemos: 'Leemos que significa ese numero.',
                paraQue: 'Cerca de 0 es casi un circulo; cerca de 1 esta muy aplastada.',
                queda: 'e = ' + F.n(e, 4) + '  (elipse)',
          ...
          guiaDelPaso = G({
            ...
            pasos: cn.e === 0 ? [
              { seccion: 'Paso 1: donde estan los focos',
                queHacemos: 'Localizamos los focos de una circunferencia.',
                paraQue: 'Una circunferencia es una elipse donde los dos focos se juntaron hasta coincidir en el centro.',
                queda: 'c = 0;  e = 0 &divide; a',
              ...
              { seccion: 'Paso 2: calcular e',
                queHacemos: 'Aplicamos e = c/a con c = 0.',
                paraQue: 'Cero entre cualquier numero da cero. Por eso la circunferencia es el caso mas redondo posible.',
                queda: 'e = 0',
              ...
              { seccion: 'Paso 1: la definicion',
                queHacemos: 'Miramos la razon entre las dos distancias.',
                paraQue: 'Si dos cosas son iguales, al dividir una entre otra da 1. Y esa razon es justo la excentricidad.',
                queda: 'razon = 1',
              ...
              { seccion: 'Paso 2: el valor',
                queHacemos: 'Damos el valor.',
                paraQue: 'La parabola es el caso frontera: separa las elipses (e &lt; 1) de las hiperbolas (e &gt; 1).',
                queda: 'e = 1',
          ...
          var pasosCl = [
            { seccion: 'Paso 1: comparar con 0',
              queHacemos: 'Vemos si vale exactamente 0.',
              paraQue: 'e = 0 solo pasa en un caso: cuando los dos focos estan pegados en el centro.',
              queda: val === 0 ? 'circunferencia' : 'no es circunferencia; hay que comparar con 1',
          ...
          if (val !== 0) {
            pasosCl.push({
              seccion: 'Paso 2: comparar con 1',
              queHacemos: 'Ubicamos el numero respecto al 1.',
              paraQue: 'El 1 es la frontera: ahi esta la parabola, y separa la elipse de la hiperbola.',
              queda: val < 1 ? 'menor que 1: elipse' : (val === 1 ? 'igual a 1: parabola' : 'mayor que 1: hiperbola'),
          ...
          pasosCl.push({
            ...
            paraQue: 'e = 0 circunferencia, 0 &lt; e &lt; 1 elipse, e = 1 parabola, e &gt; 1 hiperbola.',
            queda: tipo,
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: sacar a y b',
                queHacemos: 'Sacamos la raiz del denominador del termino que va SUMANDO.',
                paraQue: 'Ojo: en la hiperbola a NO es el denominador mayor, sino el del termino positivo.',
                queda: 'a = ' + a + ',  b = ?,  c = ?',
              ...
              { seccion: 'Paso 1: sacar a y b',
                queHacemos: 'Ahora el otro denominador.',
                paraQue: 'Para tener las dos piezas con las que se calcula c.',
                queda: 'a = ' + a + ',  b = ' + b + ',  c = ?',
              ...
              { seccion: 'Paso 2: la formula de c',
                ...
                paraQue: 'Aqui se SUMA. Por eso c sale mayor que a, y por eso la excentricidad saldra mayor que 1.',
                queda: 'a = ' + a + ';  c&sup2; = ' + (a * a + b * b),
              ...
              { seccion: 'Paso 3: dividir',
                queHacemos: 'Dividimos c entre a.',
                paraQue: 'En la hiperbola e siempre sale mayor que 1. Si te sale menor, algo se cruzo.',
                queda: 'e = ' + F.n(e, 4),
        ...
        if (t2 === 'despejaC') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: despejar c',
                queHacemos: 'Pasamos la a multiplicando.',
                paraQue: 'Es el camino de regreso: normalmente calculas e con a y b, y aqui te dan e para reconstruir la elipse.',
                queda: 'c = ' + a + ' &times; ' + e,
              ...
              { seccion: 'Paso 2: calcular c',
                ...
                paraQue: 'Comprobacion: c debe salir menor que a, como corresponde a una elipse.',
                queda: 'c = ' + F.n(c, 4) + ';  b = ?',
              ...
              { seccion: 'Paso 3: calcular b&sup2;',
                queHacemos: 'Restamos los dos cuadrados.',
                paraQue: 'En la elipse a es el mayor, asi que va primero en la resta.',
                queda: 'c = ' + F.n(c, 4) + ';  b&sup2; = ' + F.n(a * a - c * c, 4),
              ...
              { seccion: 'Paso 4: la raiz',
                queHacemos: 'Sacamos la raiz.',
                paraQue: 'Comprueba que b salga menor que a: el semieje menor nunca supera al mayor.',
                queda: 'c = ' + F.n(c, 4) + ',  b = ' + F.n(b, 4),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: calcular c',
                queHacemos: 'Multiplicamos a por e.',
                paraQue: 'El primer paso es identico al de la elipse. Fijate que c sale MAYOR que a, porque e &gt; 1.',
                queda: 'c = ' + F.n(c, 4) + ';  b = ?',
                pregunta: 'Calcula c = ' + a + ' &times; ' + e + ' (4 decimales)',
                resp: R.numero(c, { dec: 4, tol: 0.01 }),
                pista: 'De e = c/a se despeja c = a &middot; e, igual que en la elipse.',
                despues: 'c = ' + F.n(c, 4) + '. Fijate que es MAYOR que a = ' + a + ', porque e &gt; 1.' },
              { seccion: 'Paso 2: la formula de b',
                queHacemos: 'Elegimos el orden de la resta.',
                paraQue: 'Siempre el mayor menos el menor, o daria negativo. Aqui c &gt; a, asi que va c&sup2; primero.',
                queda: 'c = ' + F.n(c, 4) + ';  b&sup2; = ' + F.n(c * c - a * a, 4),
              ...
              { seccion: 'Paso 3: calcular b&sup2;',
                ...
                paraQue: 'En la elipse era al reves, porque ahi a era el mayor.',
                queda: 'c = ' + F.n(c, 4) + ';  b&sup2; = ' + F.n(c * c - a * a, 4),
              ...
              { seccion: 'Paso 4: la raiz',
                queHacemos: 'Sacamos la raiz.',
                paraQue: 'Con a y b ya se puede escribir la hiperbola completa y sus asintotas.',
                queda: 'c = ' + F.n(c, 4) + ',  b = ' + F.n(b, 4),
                pregunta: 'Saca la raiz para obtener b. (4 decimales)',
                resp: R.numero(b, { dec: 4, tol: 0.01 }),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: traducir las distancias',
                queHacemos: 'Ponemos la distancia maxima en lenguaje de elipse.',
                paraQue: 'Primera ley de Kepler: el Sol esta en UN foco, no en el centro. Por eso hay un punto lejano y uno cercano.',
                queda: 'a + c = ' + F.n(rmax, 1) + ',  a &minus; c = ' + F.n(rmin, 1),
              ...
              { seccion: 'Paso 2: sumar las ecuaciones',
                queHacemos: 'Sumamos las dos ecuaciones para que se cancele la c.',
                paraQue: 'Al sumarlas queda 2a, y de ahi sale a de un golpe.',
                queda: 'a = ' + F.n(a, 4) + ',  c = ?',
              ...
              { seccion: 'Paso 3: restar las ecuaciones',
                queHacemos: 'Ahora las restamos para que se cancele la a.',
                paraQue: 'Mismo truco al reves: queda 2c.',
                queda: 'a = ' + F.n(a, 4) + ',  c = ' + F.n(c, 4) + ';  e = ?',
                ...
                despues: '' },
              { seccion: 'Paso 4: la excentricidad',
                queHacemos: 'Dividimos c entre a.',
                paraQue: 'Las orbitas de los planetas tienen excentricidades muy chicas: son casi circulares.',
                queda: 'a = ' + F.n(a, 4) + ',  c = ' + F.n(c, 4) + ',  e = ' + F.n(e, 4),
