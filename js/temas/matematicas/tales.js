  ...
  extra.tercerSegmento = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: plantear la proporcion',
            queHacemos: 'Emparejamos los trozos de un lado con los del otro.',
            paraQue: 'El orden importa: arriba con arriba y abajo con abajo. Cruzarlos da un resultado invertido.',
            queda: F.frac(ad, F.n(db)) + ' = ' + F.frac(ae, 'EC'),
          ...
          { seccion: 'Paso 2: multiplicar en cruz',
            queHacemos: 'Multiplicamos la diagonal sin incognita.',
            paraQue: 'Asi desaparecen las fracciones y queda una ecuacion de un solo paso.',
            queda: ad + ' &middot; EC = ' + F.n(db * ae),
          ...
          { seccion: 'Paso 3: despejar',
            queHacemos: 'Dividimos para dejar sola la incognita.',
            paraQue: 'Comprobacion: si DB es mayor que AD, EC tiene que salir mayor que AE.',
            queda: 'EC = ' + F.n(ec, 2),
  ...
  extra.perimetros = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: con que escala el perimetro',
            queHacemos: 'Decidimos si el perimetro va con k o con k&sup2;.',
            paraQue: 'Longitudes con k, areas con k&sup2;, volumenes con k&sup3;. Un perimetro es una suma de lados, o sea una longitud.',
            queda: F.frac(a, b) + ' = ' + F.frac(perimetroChico, 'P'),
          ...
          { seccion: 'Paso 2: multiplicar en cruz',
            queHacemos: 'Multiplicamos la diagonal conocida.',
            paraQue: 'Para quitar las fracciones.',
            queda: a + ' &middot; P = ' + (perimetroChico * b),
            ...
            despues: '' },
          { seccion: 'Paso 3: despejar',
            queHacemos: 'Dividimos para dejar solo el perimetro.',
            paraQue: 'Comprobacion: debe salir mayor que el perimetro chico.',
            queda: 'P = ' + F.n(perimetroGrande, 2) + ' cm',
  ...
  extra.razonAreas = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: la trampa del cuadrado',
            queHacemos: 'Decidimos con que escala el area.',
            paraQue: 'Un area ocupa DOS dimensiones. Si duplicas los lados de un cuadrado, el area no se duplica: se hace cuatro veces mayor.',
            queda: 'area grande = ' + areaChica + ' &times; k&sup2;',
          ...
          { seccion: 'Paso 2: calcular k&sup2;',
            queHacemos: 'Elevamos la razon al cuadrado.',
            paraQue: 'Se eleva arriba y abajo: (' + b + '/' + a + ')&sup2; = ' + (b * b) + '/' + (a * a) + '.',
            queda: 'k&sup2; = ' + F.n(b * b / (a * a), 4),
          ...
          { seccion: 'Paso 3: aplicarlo',
            queHacemos: 'Multiplicamos el area chica por k&sup2;.',
            paraQue: 'Fijate cuanto crecio: mucho mas de lo que crecieron los lados.',
            queda: F.n(areaGrande, 2) + ' cm&sup2;',
      ...
      if (dif === 'facil') {
        ...
        if (t === 'semejantes') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: el lado del triangulo grande',
                queHacemos: 'Sumamos los dos trozos para tener el lado completo.',
                paraQue: 'Este es el paso que mas se falla: se usa solo el pedacito de arriba como si fuera el lado del grande.',
                queda: 'lado grande = ' + F.n(c),
              ...
              { seccion: 'Paso 2: la razon',
                queHacemos: 'Dividimos el lado grande entre el chico.',
                paraQue: 'Ese numero dice cuantas veces cabe el triangulo chico en el grande. Sirve para TODOS los lados.',
                queda: 'k = ' + F.n(k),
              ...
              { seccion: 'Paso 3: aplicar la razon',
                queHacemos: 'Multiplicamos el lado conocido del chico por la razon.',
                paraQue: 'Comprobacion: x debe salir mayor que la base chica.',
                queda: 'x = ' + F.n(x, 2),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: por que funciona',
                queHacemos: 'Vemos por que se pueden comparar las dos sombras.',
                paraQue: '"A la misma hora" es la clave: los rayos llegan con el mismo angulo y los dos triangulos son semejantes. A otra hora no valdria.',
                queda: 'altura &divide; sombra es la misma para los dos',
              ...
              { seccion: 'Paso 2: calcular la razon',
                queHacemos: 'Dividimos altura entre sombra en el caso conocido.',
                paraQue: 'Dice cuantos metros de alto hay por cada metro de sombra. Cualquier cosa parada ahi cumple lo mismo.',
                queda: 'razon = ' + F.n(hPersona / sPersona, 4),
              ...
              { seccion: 'Paso 3: aplicarla al arbol',
                queHacemos: 'Multiplicamos esa razon por la sombra del arbol.',
                paraQue: 'Comprobacion: la sombra del arbol es mas larga, asi que debe salir mas alto que la persona.',
                queda: 'arbol = ' + F.n(x, 2) + ' m',
        ...
        if (t2 === 'algebraico') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: producto cruzado y distribuir',
                queHacemos: 'Multiplicamos en cruz y repartimos el numero del lado izquierdo.',
                paraQue: 'Es el mismo Tales de siempre; solo que los segmentos traen una x adentro.',
                queda: Ng + 'x + ' + (Ng * p) + ' = ' + Mg + 'x + ?',
              ...
              { seccion: 'Paso 1: producto cruzado y distribuir',
                queHacemos: 'Repartimos tambien el del lado derecho.',
                paraQue: 'Con los dos parentesis abiertos ya es una ecuacion de primer grado normal.',
                queda: Ng + 'x + ' + (Ng * p) + ' = ' + Mg + 'x + ' + (Mg * q),
              ...
              { seccion: 'Paso 2: agrupar',
                queHacemos: 'Juntamos las x de un lado.',
                paraQue: 'Lo que pasa al otro lado cambia de signo.',
                queda: (Ng - Mg) + 'x = ?',
                ...
                despues: '' },
              { seccion: 'Paso 2: agrupar',
                queHacemos: 'Y juntamos los numeros del otro.',
                paraQue: 'Para dejar la ecuacion en la forma ax = b.',
                queda: (Ng - Mg) + 'x = ' + (Mg * q - Ng * p),
              ...
              { seccion: 'Paso 3: despejar',
                queHacemos: 'Dividimos para dejar la x sola.',
                paraQue: 'Se comprueba sustituyendo: la fraccion original debe simplificarse a ' + Mg + '/' + Ng + '.',
                queda: 'x = ' + sol0,
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: la razon de semejanza',
                queHacemos: 'Dividimos los dos lados que si conocemos.',
                paraQue: 'Todo el ejercicio sale de este numero. Siempre el del segundo entre su correspondiente del primero.',
                queda: 'k = ' + F.n(k),
              ...
              { seccion: 'Paso 2: los otros lados',
                queHacemos: 'Multiplicamos el segundo lado por la razon.',
                paraQue: 'La misma razon sirve para todos los lados del triangulo.',
                queda: F.n(A2) + ',  ' + F.n(B2) + ',  ?',
                ...
                despues: '' },
              { seccion: 'Paso 2: los otros lados',
                queHacemos: 'Y el tercero igual.',
                paraQue: 'Con esto ya estan los tres lados del segundo triangulo.',
                queda: F.n(A2) + ',  ' + F.n(B2) + ',  ' + F.n(C2),
              ...
              { seccion: 'Paso 3: el perimetro',
                queHacemos: 'Decidimos si sumar los tres lados o usar el atajo.',
                paraQue: 'El perimetro es una longitud, asi que tambien escala con k. Las areas serian con k&sup2;, no con k.',
                queda: 'perimetro = ' + (a + b + c) + ' &times; ' + F.n(k),
              ...
              { seccion: 'Paso 3: el perimetro',
                queHacemos: 'Calculamos el perimetro.',
                paraQue: 'Las dos formas dan lo mismo; el atajo ahorra errores.',
                queda: 'perimetro = ' + F.n(A2 + B2 + C2, 2),
              ...
              { seccion: 'Paso 4: escribir',
                ...
                queda: F.n(B2, 2) + ',  ' + F.n(C2, 2) + ',  perimetro ' + F.n(A2 + B2 + C2, 2),
