      ...
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: contar los saltos',
            queHacemos: 'Contamos los saltos que hay de la figura 1 a la que nos piden.',
            paraQue: 'Porque la formula suma la diferencia una vez por cada SALTO, no por cada figura. De la 1 a la 2 hay un salto, no dos.',
            queda: inicio + ' + ' + (k - 1) + ' &middot; ' + paso,
          ...
          { seccion: 'Paso 2: lo que se agrega',
            queHacemos: 'Multiplicamos los saltos por lo que crece en cada uno.',
            paraQue: 'Para saber cuanto se acumulo desde la primera figura hasta esa.',
            queda: inicio + ' + ' + ((k - 1) * paso),
          ...
          { seccion: 'Paso 3: sumar el inicio',
            queHacemos: 'Le sumamos lo que ya traia la figura 1.',
            paraQue: 'El primer termino es el punto de partida: nunca se pierde.',
            queda: String(val),
  ...
  extra.faltante = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: encontrar el patron',
            queHacemos: 'Restamos dos terminos seguidos que SI se ven.',
            paraQue: 'El hueco no estorba: el patron se descubre con lo que si esta, y despues se aplica.',
            queda: 'la diferencia es ' + d,
          ...
          { seccion: 'Paso 2: llegar al hueco',
            queHacemos: 'Localizamos el termino que esta justo antes del hueco.',
            paraQue: 'Desde ese solo hay que dar un salto para caer en el que falta.',
            queda: v[hueco - 1] + ' + (' + d + ')',
            ...
            despues: '' },
          { seccion: 'Paso 2: llegar al hueco',
            queHacemos: 'Avanzamos un salto desde el termino anterior.',
            paraQue: 'Para obtener el termino que faltaba.',
            queda: String(v[hueco]),
          ...
          { seccion: 'Paso 3: comprobar',
            queHacemos: 'Verificamos hacia el otro lado.',
            paraQue: 'Si el numero es correcto, el patron tiene que funcionar tambien hacia adelante.',
            queda: String(v[hueco]),
      ...
      if (dif === 'facil') {
        ...
        if (t === 'aritmetica') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: que tipo es',
                queHacemos: 'Probamos si las diferencias son constantes. No lo son.',
                paraQue: 'Siempre se prueba restando primero. Si falla, se prueba dividiendo.',
                queda: 'geometrica: se multiplica',
              ...
              { seccion: 'Paso 2: la razon',
                queHacemos: 'Dividimos un termino entre el anterior.',
                paraQue: 'En una geometrica lo que se repite es el cociente, no la resta.',
                queda: v[4] + ' &times; (' + q + ')',
              ...
              { seccion: 'Paso 3: avanzar',
                queHacemos: 'Multiplicamos el ultimo termino por la razon.',
                paraQue: 'Aqui NO se suma: se multiplica.',
                queda: String(g1 * Math.pow(q, 5)),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: mirar las diferencias',
                queHacemos: 'Restamos los dos primeros terminos.',
                paraQue: 'Es lo primero que se prueba siempre.',
                queda: 'diferencias: ' + (v[1] - v[0]) + ', ?',
                pregunta: 'Primera diferencia: ' + v[1] + ' &minus; ' + v[0],
                resp: R.numero(v[1] - v[0], { dec: 0 }),
                pista: 'Resta normal.', despues: '' },
              { seccion: 'Paso 1: mirar las diferencias',
                queHacemos: 'Y la siguiente.',
                paraQue: 'Para ver si son constantes o si siguen algun patron.',
                queda: 'diferencias: ' + (v[1] - v[0]) + ', ' + (v[2] - v[1]) + ', ' + (v[3] - v[2]),
              ...
              k ? { seccion: 'Paso 2: identificar el patron',
                    queHacemos: 'Comparamos con los cuadrados y vemos cuanto les falta.',
                    paraQue: 'Diferencias que suben de 2 en 2 delatan siempre a los cuadrados.',
                    queda: 'a&#8345; = n&sup2; + ' + k,
                    pregunta: 'Los cuadrados puros son 1, 4, 9, 16, 25.<br>&iquest;Cuanto hay que sumarles para llegar a esta sucesion?',
                resp: R.numero(k, { dec: 0 }),
                pista: 'Compara termino a termino: ' + v[0] + ' &minus; 1 = ' + k + '.',
                despues: 'Entonces el termino n-esimo es n&sup2; + ' + k + '.' }
                : { seccion: 'Paso 2: identificar el patron',
                  queHacemos: 'Comparamos con los cuadrados perfectos.',
                  paraQue: 'Diferencias que suben de 2 en 2 delatan siempre a los cuadrados.',
                  queda: 'a&#8345; = n&sup2;',
              ...
              { seccion: 'Paso 3: evaluar',
                queHacemos: 'Aplicamos la formula en la posicion 6.',
                paraQue: 'Para obtener el termino que nos piden.',
                queda: String(36 + k),
        ...
        if (t2 === 'generalLineal') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: la diferencia',
                queHacemos: 'Restamos dos terminos seguidos.',
                paraQue: 'Si la diferencia es constante, ya sabemos que la formula va a ser lineal.',
                queda: 'a&#8345; = ' + m + 'n + b',
              ...
              { seccion: 'Paso 2: la forma de la formula',
                queHacemos: 'Decidimos que tipo de formula buscamos.',
                paraQue: 'Sumar siempre lo mismo hace crecer la sucesion en linea recta, igual que y = mx + b.',
                queda: 'a&#8345; = ' + m + 'n + b',
              ...
              { seccion: 'Paso 3: encontrar b',
                queHacemos: 'Sustituimos n = 1 y despejamos la b.',
                paraQue: 'Ya sabemos el m; el b se saca obligando a que la formula de el primer termino correcto.',
                queda: 'a&#8345; = ' + F.poli([m, b], 'n'),
              ...
              { seccion: 'Paso 4: escribir',
                queHacemos: 'Escribimos la formula completa.',
                paraQue: 'Con ella se puede sacar cualquier termino sin contar uno por uno.',
                queda: 'a&#8345; = ' + F.poli([m, b], 'n'),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: separar el problema',
                queHacemos: 'Partimos el problema en dos: los numeros por un lado y los signos por otro.',
                paraQue: 'Por separado cada parte es facilisima; juntas parecen un desastre.',
                queda: 'numeros: ' + [base, base + paso, base + 2 * paso].join(', ') + ', ...',
              ...
              { seccion: 'Paso 2: el numero',
                queHacemos: 'Seguimos el patron de los valores absolutos.',
                paraQue: 'Sin signos, es una sucesion aritmetica normal.',
                queda: 'septimo: ' + (base + 6 * paso) + ' (falta el signo)',
              ...
              { seccion: 'Paso 3: el signo',
                queHacemos: 'Vemos que signo le toca a esa posicion.',
                paraQue: 'Los signos van uno si y uno no: basta con mirar el anterior.',
                queda: String(s6),
              ...
              { seccion: 'Paso 4: el siguiente',
                queHacemos: 'Repetimos las dos partes para el octavo termino.',
                paraQue: 'Para tener los dos que nos piden.',
                queda: s6 + ', ' + s7,
                ...
                despues: '' },
              { seccion: 'Paso 4: el siguiente',
                queHacemos: 'Escribimos los dos juntos.',
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: entender la regla',
                queHacemos: 'Leemos la regla y vemos de cuantos terminos depende.',
                paraQue: 'En una sucesion recursiva no hay formula directa: cada termino se apoya en los anteriores.',
                queda: 'hacen falta los 2 ultimos',
              ...
              { seccion: 'Paso 2: tomar los ultimos',
                queHacemos: 'Localizamos los dos ultimos terminos que se ven.',
                paraQue: 'Son los que alimentan el siguiente.',
                queda: v[4] + ' + ' + v[5],
                ...
                despues: '' },
              { seccion: 'Paso 3: aplicar la regla',
                queHacemos: 'Los sumamos.',
                paraQue: 'Para obtener el siguiente termino.',
                queda: String(v[4] + v[5]),
        ...
        if (t3 === 'cuadratica') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: primeras diferencias',
                queHacemos: 'Calculamos las diferencias entre terminos seguidos.',
                paraQue: 'El metodo de las diferencias: si hay que bajar dos niveles para encontrar algo constante, la formula es de grado 2.',
                queda: 'diferencias: ' + (v[1] - v[0]) + ', ?',
                pregunta: 'Primera diferencia: ' + v[1] + ' &minus; (' + v[0] + ')',
                resp: R.numero(v[1] - v[0], { dec: 0 }),
              ...
              { seccion: 'Paso 1: primeras diferencias',
                queHacemos: 'Calculamos las diferencias entre terminos seguidos.',
                paraQue: 'El metodo de las diferencias: si hay que bajar dos niveles para encontrar algo constante, la formula es de grado 2.',
                queda: 'diferencias: ' + [v[1] - v[0], v[2] - v[1], v[3] - v[2]].join(', '),
              ...
              { seccion: 'Paso 2: segundas diferencias',
                queHacemos: 'Restamos las diferencias entre si.',
                paraQue: 'Si en este nivel si sale constante, la formula es cuadratica.',
                queda: 'segunda diferencia = ' + (2 * A),
              ...
              { seccion: 'Paso 3: sacar a, b y c',
                queHacemos: 'Dividimos la segunda diferencia entre 2 para obtener el coeficiente principal.',
                paraQue: 'Es una propiedad fija: en cualquier cuadratica la segunda diferencia vale 2a.',
                queda: 'a&#8345; = ' + A + 'n&sup2; + bn + c',
              ...
              { seccion: 'Paso 3: sacar a, b y c',
                queHacemos: 'Planteamos dos ecuaciones y las restamos para que se vaya la c.',
                paraQue: 'Restando se elimina una incognita y queda solo la b.',
                queda: 'a&#8345; = ' + A + 'n&sup2; ' + (B < 0 ? '&minus; ' + (-B) : '+ ' + B) + 'n + c',
                ...
                despues: '' },
              { seccion: 'Paso 3: sacar a, b y c',
                queHacemos: 'Con a y b ya conocidos, despejamos la c.',
                paraQue: 'Para completar la formula.',
                queda: 'a&#8345; = ' + F.poli([A, B, C], 'n'),
              ...
              { seccion: 'Paso 4: escribir',
                queHacemos: 'Escribimos la formula completa.',
                paraQue: 'Con ella se saca cualquier termino directamente.',
                queda: 'a&#8345; = ' + F.poli([A, B, C], 'n'),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: el primer termino',
                queHacemos: 'Anotamos el primer termino de la lista.',
                paraQue: 'La formula de una geometrica arranca siempre desde a1.',
                queda: 'a&#8345; = ' + g + ' &middot; r' + F.sup('n&minus;1'),
                pregunta: '&iquest;Cual es el primer termino, a<sub>1</sub>?',
                resp: R.numero(g, { dec: 0 }),
                pista: 'Es el que abre la lista.', despues: '' },
              { seccion: 'Paso 2: la razon',
                queHacemos: 'Dividimos un termino entre el anterior.',
                paraQue: 'En una geometrica lo que se repite es el cociente.',
                queda: 'a&#8345; = ' + g + ' &middot; ' + rz + F.sup('n&minus;1'),
                pregunta: 'Encuentra la razon dividiendo: ' + v[1] + ' &divide; ' + v[0],
                resp: R.numero(rz, { dec: 0 }),
                pista: 'Comprueba con otro par: ' + v[2] + ' &divide; ' + v[1] + ' da lo mismo.',
                despues: 'La razon es r = ' + rz + '.' },
              { seccion: 'Paso 3: por que n &minus; 1',
                queHacemos: 'Entendemos de donde sale ese exponente.',
                paraQue: 'Con n = 1 el exponente debe dar 0, para que quede a1 tal cual sin multiplicar por nada.',
                queda: 'a&#8345; = ' + g + ' &middot; ' + rz + F.sup('n&minus;1'),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: entender la regla',
                queHacemos: 'Vemos si hay atajo o hay que ir uno por uno.',
                paraQue: 'La regla depende del termino anterior, no de la posicion: no hay forma de saltarse pasos.',
                queda: 'hay que calcular a&#8326; primero',
              ...
              { seccion: 'Paso 2: calcular a6',
                queHacemos: 'Aplicamos la regla al ultimo termino conocido.',
                paraQue: 'Para avanzar un escalon.',
                queda: 'a&#8326; = ' + a6,
              ...
              { seccion: 'Paso 3: calcular a7',
                queHacemos: 'Repetimos la regla con el termino que acabamos de obtener.',
                paraQue: 'Para llegar al que nos piden.',
                queda: 'a&#8327; = ' + a7,
