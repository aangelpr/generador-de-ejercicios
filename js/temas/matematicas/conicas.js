  ...
  extra.parabolaHorizontal = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: hacia donde abre',
            queHacemos: 'Miramos cual de las dos variables esta al cuadrado.',
            paraQue: 'Eso decide todo: si la elevada es la y, la parabola abre en HORIZONTAL, no hacia arriba.',
            queda: 'abre en horizontal;  vertice (?, ?)',
          ...
          { seccion: 'Paso 2: el vertice',
            queHacemos: 'Leemos la x del vertice.',
            paraQue: 'Sale del parentesis con el signo cambiado.',
            queda: 'vertice (' + h + ', ?)',
          ...
          { seccion: 'Paso 2: el vertice',
            ...
            paraQue: 'Aqui la elevada es la y, asi que su valor sale del cuadrado.',
            queda: 'vertice (' + h + ', ' + k + ');  falta el foco',
            ...
            despues: 'Vertice: (' + h + ', ' + k + ').' },
          { seccion: 'Paso 3: el valor de p',
            queHacemos: 'Dividimos entre 4 el coeficiente de afuera.',
            paraQue: 'p es la distancia del vertice al foco, y su signo dice hacia que lado.',
            queda: 'vertice (' + h + ', ' + k + '),  p = ' + p,
          ...
          { seccion: 'Paso 4: el foco',
            queHacemos: 'Le sumamos p a la x del vertice.',
            paraQue: 'Como abre en horizontal, el foco se corre en x y la y no cambia.',
            queda: 'vertice (' + h + ', ' + k + '),  foco (' + (h + p) + ', ' + k + ')',
            ...
            despues: '' },
          { seccion: 'Paso 5: el sentido',
            queHacemos: 'Miramos el signo de p.',
            paraQue: 'p positivo abre a la derecha; p negativo, a la izquierda. La curva siempre abre HACIA el foco.',
            queda: 'foco (' + (h + p) + ', ' + k + '),  abre a la ' + (p > 0 ? 'derecha' : 'izquierda'),
          ...
          { seccion: 'Paso 6: escribir',
            queHacemos: 'Damos vertice, foco y sentido.',
            paraQue: 'Para cerrar el ejercicio.',
            queda: 'vertice (' + h + ', ' + k + '),  foco (' + (h + p) + ', ' + k + '),  abre a la ' + (p > 0 ? 'derecha' : 'izquierda'),
      ...
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: el centro',
            queHacemos: 'Leemos la x del centro.',
            paraQue: 'Es la elipse de siempre, solo que trasladada. El centro sale de los parentesis con el signo cambiado.',
            queda: 'centro (' + h + ', ?)',
          ...
          { seccion: 'Paso 1: el centro',
            queHacemos: 'Ahora la y.',
            paraQue: 'Con el centro ya localizado, todo lo demas se calcula igual que en la elipse del origen.',
            queda: 'centro (' + h + ', ' + k + ')',
          ...
          { seccion: 'Paso 2: calcular c',
            queHacemos: 'Restamos los dos denominadores.',
            paraQue: 'En la elipse se RESTA y en la hiperbola se SUMA. Confundirlas es el error mas comun del tema.',
            queda: 'centro (' + h + ', ' + k + ');  c&sup2; = ' + (a * a - b * b),
          ...
          { seccion: 'Paso 2: calcular c',
            ...
            paraQue: 'Comprobacion: c tiene que salir menor que a, porque los focos estan DENTRO de la curva.',
            queda: 'centro (' + h + ', ' + k + '),  c = ' + F.n(c, 2),
          ...
          { seccion: 'Paso 3: donde van los focos',
            queHacemos: 'Decidimos sobre que eje se colocan.',
            paraQue: 'Los focos van siempre sobre el eje MAYOR, que es el de la variable con el denominador mas grande.',
            queda: 'centro (' + h + ', ' + k + '),  c = ' + F.n(c, 2) + ';  focos (h &plusmn; c, k)',
          ...
          { seccion: 'Paso 4: el foco derecho',
            queHacemos: 'Le sumamos c a la x del centro.',
            paraQue: 'Aqui se nota la traslacion: si el centro fuera el origen, el foco seria c a secas.',
            queda: 'centro (' + h + ', ' + k + '),  c = ' + F.n(c, 2) + ',  foco (' + F.n(h + c, 2) + ', ' + k + ')',
          ...
          { seccion: 'Paso 5: escribir',
            queHacemos: 'Damos centro, c y el foco derecho.',
            paraQue: 'Para cerrar el ejercicio.',
            queda: 'centro (' + h + ', ' + k + '),  c = ' + F.n(c, 2) + ',  foco (' + F.n(h + c, 2) + ', ' + k + ')',
            pregunta: 'Escribe las cuatro respuestas.',
            resp: R.varios([
  ...
  EJ.tema({
    ...
    generar: function (dif, r) {
      ...
      if (dif === 'facil') {
        ...
        var pasosId = [
          { seccion: 'Paso 1: contar los cuadrados',
            queHacemos: 'Contamos cuantas variables aparecen al cuadrado.',
            paraQue: 'Con una sola ya esta resuelto: es parabola. Con dos hay que seguir preguntando.',
            queda: idx === 1 ? 'una sola: parabola' : 'dos cuadrados: falta decidir',
        ...
        if (idx !== 1) {
          pasosId.push({
            seccion: 'Paso 2: comparar los signos',
            queHacemos: 'Miramos si los dos coeficientes son del mismo signo.',
            paraQue: 'Si uno es positivo y el otro negativo, la curva se rompe en dos ramas: hiperbola.',
            queda: idx === 3 ? 'signos contrarios: hiperbola' : 'mismo signo: circunferencia o elipse',
          ...
          if (idx !== 3) {
            pasosId.push({
              seccion: 'Paso 3: comparar los numeros',
              queHacemos: 'Comparamos los dos coeficientes.',
              paraQue: 'Iguales quiere decir que estira lo mismo en las dos direcciones: circunferencia. Distintos, elipse.',
              queda: idx === 0 ? 'coeficientes iguales: circunferencia' : 'distintos: elipse',
        ...
        pasosId.push({
          ...
          queHacemos: 'Damos el nombre de la conica.',
          paraQue: 'Los terminos lineales y la constante no cambian el tipo: solo la mueven de sitio.',
          queda: TIPOS[idx],
        ...
        if (t === 'circulo') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: hacia donde abre',
                queHacemos: 'Vemos cual variable esta al cuadrado.',
                paraQue: 'La elevada es la x, asi que el eje es VERTICAL: abre hacia arriba o hacia abajo.',
                queda: 'eje vertical;  vertice (?, ?)',
              ...
              { seccion: 'Paso 2: el vertice',
                queHacemos: 'Ahora la y.',
                paraQue: 'La forma (x &minus; h)&sup2; = 4p(y &minus; k) trae el vertice a la vista, en los parentesis.',
                queda: 'vertice (' + h + ', ' + k + ');  falta el foco',
              ...
              { seccion: 'Paso 3: el valor de p',
                queHacemos: 'Dividimos entre 4 el coeficiente de afuera.',
                paraQue: 'p es la distancia del vertice al foco. Si es positivo abre hacia arriba; si es negativo, hacia abajo.',
                queda: 'vertice (' + h + ', ' + k + '),  p = ' + p,
                pregunta: 'El coeficiente de afuera es 4p = ' + (4 * p) + '.<br>&iquest;Cuanto vale p?',
                resp: R.numero(p, { dec: 2 }),
              ...
              { seccion: 'Paso 4: el foco',
                queHacemos: 'Copiamos la x del vertice.',
                paraQue: 'Con eje vertical el foco se mueve solo en y: la x no cambia.',
                queda: 'vertice (' + h + ', ' + k + '),  foco (' + h + ', ?)',
                pregunta: 'El eje es vertical, asi que la x del foco es la misma del vertice.<br>&iquest;Cual es?',
                resp: R.numero(h, { dec: 2 }),
                pista: 'No cambia: ' + h + '.',
                despues: '' },
              { seccion: 'Paso 4: el foco',
                queHacemos: 'Le sumamos p a la y del vertice.',
                paraQue: 'La curva siempre abre HACIA el foco. La directriz queda al otro lado, en y = ' + (k - p) + '.',
                queda: 'vertice (' + h + ', ' + k + '),  foco (' + h + ', ' + (k + p) + ')',
              ...
              { seccion: 'Paso 5: escribir',
                queHacemos: 'Damos vertice y foco.',
                paraQue: 'Para cerrar el ejercicio.',
                queda: 'vertice (' + h + ', ' + k + '),  foco (' + h + ', ' + (k + p) + ')',
                pregunta: 'Escribe las cuatro respuestas.',
                resp: R.varios([
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: leer a y b',
                queHacemos: 'Vemos de donde se sacan a y b.',
                paraQue: 'Los denominadores son a&sup2; y b&sup2;, no a y b. Hay que sacarles la raiz.',
                queda: 'a = &radic;' + (a * a) + ',  b = &radic;' + (b * b) + ',  c = ?',
              ...
              { seccion: 'Paso 1: leer a y b',
                queHacemos: 'Sacamos la raiz del denominador mayor.',
                paraQue: 'a es el semieje mayor: la distancia del centro al punto mas lejano de la curva.',
                queda: 'a = ' + a + ',  b = ?,  c = ?',
                ...
                despues: '' },
              { seccion: 'Paso 1: leer a y b',
                queHacemos: 'Y la del menor.',
                paraQue: 'b es el semieje menor.',
                queda: 'a = ' + a + ',  b = ' + b + ',  c = ?',
                pregunta: 'Y b = &radic;<span class="rad">' + (b * b) + '</span>',
                resp: R.numero(b, { dec: 2, tol: 0.01 }),
                pista: 'Lo mismo con el otro denominador.',
                despues: '' },
              { seccion: 'Paso 2: la formula de c',
                queHacemos: 'Elegimos entre sumar o restar.',
                paraQue: 'En la elipse se RESTA. Tiene sentido: los focos estan DENTRO de la curva, asi que c debe ser menor que a.',
                queda: 'a = ' + a + ',  b = ' + b + ';  c&sup2; = ' + (a * a - b * b),
              ...
              { seccion: 'Paso 3: calcular c',
                queHacemos: 'Sacamos la raiz.',
                paraQue: 'Comprobacion: si c te sale mayor que a, sumaste en vez de restar.',
                queda: 'a = ' + a + ',  b = ' + b + ',  c = ' + F.n(c, 2),
              ...
              { seccion: 'Paso 4: escribir',
                queHacemos: 'Damos los tres numeros.',
                paraQue: 'Para cerrar el ejercicio.',
                queda: 'a = ' + a + ',  b = ' + b + ',  c = ' + F.n(c, 2),
        ...
        if (t2 === 'general') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: agrupar',
                queHacemos: 'Juntamos las x, las y, y mandamos la constante al otro lado.',
                paraQue: 'Para completar el cuadrado hace falta tener cada variable en su propio grupo.',
                queda: '(x&sup2; ' + (D >= 0 ? '+ ' + D : '&minus; ' + (-D)) + 'x) + (y&sup2; ' + (E >= 0 ? '+ ' + E : '&minus; ' + (-E)) + 'y) = ' + (-Fc),
              ...
              { seccion: 'Paso 2: completar en x',
                queHacemos: 'Calculamos la mitad del coeficiente de x y la elevamos al cuadrado.',
                paraQue: 'Ese numero es justo lo que falta para que el grupo se vuelva un parentesis al cuadrado.',
                queda: 'sumar ' + ((D / 2) * (D / 2)) + ' por la x  y  ? por la y',
              ...
              { seccion: 'Paso 3: completar en y',
                queHacemos: 'Repetimos con la y.',
                paraQue: 'Son exactamente los mismos pasos, otra vez.',
                queda: 'sumar ' + ((D / 2) * (D / 2)) + ' por la x  y  ' + ((E / 2) * (E / 2)) + ' por la y',
              ...
              { seccion: 'Paso 4: equilibrar',
                queHacemos: 'Sumamos lo mismo en el lado derecho.',
                paraQue: 'Si solo sumas de un lado cambias la ecuacion. Este es el paso que mas se olvida.',
                queda: cuad('x', h) + ' + ' + cuad('y', k) + ' = ' + (a * a),
              ...
              { seccion: 'Paso 5: leer el centro',
                queHacemos: 'Leemos la x del centro.',
                paraQue: 'Ya en forma ordinaria, el centro se lee del parentesis con el signo cambiado.',
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: la formula de c',
                queHacemos: 'Elegimos entre sumar o restar.',
                paraQue: 'Al reves que en la elipse: aqui se SUMA, porque los focos quedan mas lejos que los vertices.',
              ...
              { seccion: 'Paso 2: calcular c',
                queHacemos: 'Sacamos la raiz.',
                paraQue: 'Comprobacion: c tiene que salir MAYOR que a.',
                queda: 'c = ' + F.n(c, 2) + ';  faltan vertice y asintotas',
              ...
              { seccion: 'Paso 3: los vertices',
                queHacemos: 'Localizamos los vertices.',
                paraQue: 'Van sobre el eje de la variable que va SUMANDO. El otro eje no toca la curva.',
                queda: 'c = ' + F.n(c, 2) + ',  vertice (' + a + ', 0);  falta la pendiente',
                ...
                despues: '' },
              { seccion: 'Paso 4: las asintotas',
                queHacemos: 'Calculamos la pendiente b/a.',
                paraQue: 'Son las dos rectas a las que la curva se acerca sin tocarlas nunca. Solo existen en la hiperbola.',
                queda: 'c = ' + F.n(c, 2) + ',  vertice (' + a + ', 0),  pendiente ' + F.n(b / a, 2),
              ...
              { seccion: 'Paso 5: escribir',
                queHacemos: 'Damos c, el vertice y la pendiente.',
                paraQue: 'Para cerrar el ejercicio.',
                queda: 'c = ' + F.n(c, 2) + ',  vertice (' + a + ', 0),  pendiente ' + F.n(b / a, 2),
                pregunta: 'Escribe las tres respuestas.',
                resp: R.varios([
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: que hace falta',
                queHacemos: 'Vemos que dato falta para armar la ecuacion.',
                paraQue: 'Es el problema al reves: el centro ya lo dan, asi que solo falta el radio.',
                queda: cuad('x', h) + ' + ' + cuad('y', k) + ' = ?',
              ...
              { seccion: 'Paso 2: el radio',
                queHacemos: 'Calculamos la distancia del centro al punto.',
                paraQue: 'No hace falta Pitagoras: al estar alineados horizontalmente, &Delta;y = 0.',
                queda: 'radio ' + a + ';  lado derecho ?',
              ...
              { seccion: 'Paso 3: el lado derecho',
                queHacemos: 'Elevamos el radio al cuadrado.',
                paraQue: 'Este es el error tipico al reves: aqui hay que ELEVAR, no sacar raiz.',
                queda: cuad('x', h) + ' + ' + cuad('y', k) + ' = ' + (a * a),
              ...
              { seccion: 'Paso 4: escribir',
                queHacemos: 'Damos el radio y el lado derecho.',
                paraQue: 'Para cerrar el ejercicio.',
                queda: 'radio ' + a + ',  r&sup2; = ' + (a * a),
