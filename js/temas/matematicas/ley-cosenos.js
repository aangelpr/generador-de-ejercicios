  ...
  extra.paralelogramo = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: el otro angulo',
            queHacemos: 'Sacamos el angulo de la otra esquina.',
            paraQue: 'Cada diagonal se opone a un angulo distinto: por eso las dos diagonales no miden lo mismo.',
            queda: 'angulos: ' + ang + '&deg; y ' + (180 - ang) + '&deg;',
          ...
          { seccion: 'Paso 2: primera diagonal',
            queHacemos: 'Sacamos el coseno del primer angulo.',
            paraQue: 'Los dos lados del paralelogramo hacen de a y b, y la diagonal es el lado c de la formula.',
            queda: 'd&sub1;&sup2; = ' + (a * a) + ' + ' + (b * b) + ' &minus; ' + (2 * a * b) + '(' + F.n(Math.cos(rad(ang)), 4) + ')',
            ...
            despues: '' },
          { seccion: 'Paso 2: primera diagonal',
            queHacemos: 'Aplicamos la formula y sacamos la raiz.',
            paraQue: 'Es la ley de cosenos de siempre; lo unico nuevo es ver donde esta el triangulo.',
            queda: 'd&sub1; = ' + F.n(menor, 2) + ',  d&sub2; = ?',
            ...
            despues: '' },
          { seccion: 'Paso 3: segunda diagonal',
            queHacemos: 'Repetimos con el angulo suplementario.',
            paraQue: 'Como ahora el coseno cambia de signo, esta diagonal sale distinta: una corta y otra larga.',
            queda: 'd&sub1; = ' + F.n(menor, 2) + ',  d&sub2; = ' + F.n(mayor, 2),
          ...
          { seccion: 'Paso 4: escribir',
            queHacemos: 'Damos las dos diagonales.',
            paraQue: 'Comprobacion: la diagonal larga siempre se opone al angulo obtuso.',
            queda: 'd&sub1; = ' + F.n(menor, 2) + ',  d&sub2; = ' + F.n(mayor, 2),
  ...
  extra.clasifica = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: el lado mayor',
            queHacemos: 'Buscamos el lado mas largo.',
            paraQue: 'Frente a el esta el angulo mayor, el unico que puede pasar de 90&deg;. Si ese es agudo, los tres lo son.',
            queda: 'comparar ' + mayor2 + '  contra  ' + lados[0] + '&sup2; + ' + lados[1] + '&sup2;',
          ...
          { seccion: 'Paso 2: los dos numeros',
            ...
            paraQue: 'Es uno de los dos numeros de la comparacion.',
            queda: mayor2 + '  contra  ?',
          ...
          { seccion: 'Paso 2: los dos numeros',
            ...
            paraQue: 'Ya se pueden comparar.',
            queda: mayor2 + '  contra  ' + suma,
          ...
          { seccion: 'Paso 3: clasificar',
            queHacemos: 'Comparamos y decidimos.',
            paraQue: 'Iguales: rectangulo (eso es Pitagoras). Menor: el coseno sale positivo y el angulo es agudo. Mayor: el coseno sale negativo y pasa de 90&deg;.',
            queda: idx === 1 ? 'rectangulo' : (idx === 0 ? 'acutangulo' : 'obtusangulo'),
      ...
      if (dif === 'facil') {
        ...
        if (t === 'angulo') {
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: elegir la ley',
                queHacemos: 'Decidimos que ley usar con los datos que hay.',
                paraQue: 'Con tres lados la ley de senos no arranca: no hay ninguna pareja lado-angulo completa.',
                queda: 'cos C = (' + (a * a) + ' + ' + (b * b) + ' &minus; ' + (c * c) + ') &divide; ' + (2 * a * b),
              ...
              { seccion: 'Paso 2: el numerador',
                queHacemos: 'Sumamos los cuadrados de los dos lados y restamos el del opuesto.',
                paraQue: 'El que RESTA es siempre el lado opuesto al angulo que buscamos.',
                queda: 'cos C = ' + (a * a + b * b - c * c) + ' &divide; ?',
              ...
              { seccion: 'Paso 3: el denominador',
                queHacemos: 'Multiplicamos 2 por los dos lados que si tocan el angulo.',
                paraQue: 'Abajo van los dos lados que forman el angulo, nunca el opuesto.',
                queda: 'cos C = ' + (a * a + b * b - c * c) + ' &divide; ' + (2 * a * b),
                pregunta: 'Y el denominador: 2 &times; ' + a + ' &times; ' + b,
                resp: R.numero(2 * a * b, { dec: 0 }),
                pista: 'Los dos lados que TOCAN al angulo C.', despues: '' },
              { seccion: 'Paso 4: el coseno',
                queHacemos: 'Hacemos la division.',
                paraQue: 'Si sale negativo, el angulo pasa de 90&deg;. Esto TODAVIA no es el angulo.',
                queda: 'cos C = ' + F.n(cosC, 4),
                ...
                despues: '' },
              { seccion: 'Paso 5: deshacer el coseno',
                queHacemos: 'Aplicamos arccos.',
                paraQue: 'Calculadora en grados. El arccos no tiene la ambiguedad del arcsen: el signo delata si es agudo u obtuso.',
                queda: 'C = ' + F.n(C, 2) + '&deg;',
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: a que lado se opone',
                queHacemos: 'Localizamos el lado mayor.',
                paraQue: 'A mayor lado, mayor angulo opuesto. Es proporcional, no al azar.',
                queda: 'cos = (' + (otros[0] * otros[0]) + ' + ' + (otros[1] * otros[1]) + ' &minus; ' + (mayor * mayor) + ') &divide; ' + (2 * otros[0] * otros[1]),
              ...
              { seccion: 'Paso 2: el numerador',
                queHacemos: 'Sumamos los cuadrados de los dos chicos y restamos el del mayor.',
                paraQue: 'Si sale negativo, el angulo mayor pasa de 90&deg; y el triangulo es obtusangulo.',
                queda: 'cos = ' + (otros[0] * otros[0] + otros[1] * otros[1] - mayor * mayor) + ' &divide; ' + (2 * otros[0] * otros[1]),
              ...
              { seccion: 'Paso 3: el coseno',
                queHacemos: 'Hacemos la division.',
                paraQue: 'Abajo van los dos lados que forman el angulo.',
                queda: 'cos = ' + F.n(cosM, 4),
              ...
              { seccion: 'Paso 4: el angulo',
                queHacemos: 'Aplicamos arccos.',
                paraQue: 'Comprobacion: debe salir mayor que 60&deg;, porque si los tres fueran menores no sumarian 180&deg;.',
                queda: 'angulo mayor = ' + F.n(angM, 2) + '&deg;',
        ...
        if (t2 === 'navegacion') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: elegir la ley',
                queHacemos: 'Vemos por que Pitagoras no sirve.',
                paraQue: 'Pitagoras solo vale con un angulo de 90&deg;. La ley de cosenos es su version general, para cualquier angulo.',
                queda: 'd&sup2; = ' + (v1 * v1) + ' + ' + (v2 * v2) + ' &minus; ' + (2 * v1 * v2) + ' cos ' + ang + '&deg;',
              ...
              { seccion: 'Paso 2: el coseno',
                queHacemos: 'Sacamos el coseno del angulo entre las dos rutas.',
                paraQue: 'Si el angulo pasa de 90&deg; sale negativo, y entonces la distancia crece en vez de encogerse.',
                queda: 'cos ' + ang + '&deg; = ' + F.n(Math.cos(rad(ang)), 4),
              ...
              { seccion: 'Paso 3: la formula',
                queHacemos: 'Aplicamos la ley de cosenos completa.',
                paraQue: 'Los dos recorridos son los lados a y b, y la separacion final es el lado c.',
              ...
              { seccion: 'Paso 4: la raiz',
                ...
                paraQue: 'Comprobacion: debe salir menor que la suma de los dos recorridos.',
                queda: 'd = ' + F.n(d, 2),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: el lado que falta',
                queHacemos: 'Aplicamos la ley de cosenos para el tercer lado.',
                paraQue: 'Con dos lados y el angulo entre ellos solo se puede empezar por aqui: la ley de senos no arranca.',
                queda: 'c = ' + F.n(c, 2) + ';  faltan A y B',
              ...
              { seccion: 'Paso 2: que ley usar ahora',
                queHacemos: 'Elegimos cosenos en vez de senos para el angulo.',
                paraQue: 'Con arcsen un angulo obtuso se disfraza de agudo. Con arccos no pasa: el signo del coseno lo delata.',
                queda: 'c = ' + F.n(c, 2) + ';  cos A = (b&sup2; + c&sup2; &minus; a&sup2;) &divide; 2bc',
              ...
              { seccion: 'Paso 3: el coseno de A',
                queHacemos: 'Aplicamos la formula despejada.',
                paraQue: 'Ahora el que resta es a, porque A es el angulo opuesto al lado a.',
                queda: 'c = ' + F.n(c, 2) + ';  cos A = ' + F.n((b * b + c * c - a * a) / (2 * b * c), 4),
                ...
                despues: '' },
              { seccion: 'Paso 4: el angulo A',
                queHacemos: 'Aplicamos arccos.',
                paraQue: 'Ya tenemos dos de los tres angulos.',
                queda: 'c = ' + F.n(c, 2) + ',  A = ' + F.n(A, 2) + '&deg;;  falta B',
                pregunta: 'Aplica arccos para obtener A. (2 decimales)',
                resp: R.numero(A, { dec: 2, tol: 0.05 }),
                pista: 'arccos(' + F.n((b * b + c * c - a * a) / (2 * b * c), 4) + ').',
                despues: '' },
              { seccion: 'Paso 5: el angulo B',
                queHacemos: 'Restamos a 180&deg;.',
                paraQue: 'No hace falta mas trigonometria: el tercer angulo siempre sale de la suma.',
                queda: 'c = ' + F.n(c, 2) + ',  A = ' + F.n(A, 2) + '&deg;,  B = ' + F.n(B, 2) + '&deg;',
              ...
              { seccion: 'Paso 6: escribir',
                ...
                paraQue: 'El triangulo queda resuelto.',
                queda: 'c = ' + F.n(c, 2) + ',  A = ' + F.n(A, 2) + '&deg;,  B = ' + F.n(B, 2) + '&deg;',
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: el coseno de A',
                queHacemos: 'Aplicamos la ley de cosenos despejada.',
                paraQue: 'El lado que resta es a, porque A es el angulo opuesto a el. Si el coseno sale negativo, A es obtuso.',
                queda: 'cos A = ' + F.n(cosA, 4),
              ...
              { seccion: 'Paso 2: el angulo A',
                queHacemos: 'Aplicamos arccos.',
                paraQue: 'Calculadora en grados.',
                queda: 'A = ' + F.n(A, 2) + '&deg;;  falta el area',
                pregunta: 'Aplica arccos. &iquest;Cuanto mide A? (2 decimales)',
                resp: R.numero(A, { dec: 2, tol: 0.05 }),
                pista: 'arccos(' + F.n(cosA, 4) + '), con la calculadora en grados.',
                despues: '' },
              { seccion: 'Paso 3: el semiperimetro',
                queHacemos: 'Sumamos los tres lados y dividimos entre 2.',
                paraQue: 'Heron calcula el area sin necesitar ninguna altura ni ningun angulo: solo los tres lados.',
                queda: 'A = ' + F.n(A, 2) + '&deg;;  s = ' + F.n(s, 2),
                ...
                despues: 's = ' + F.n(s, 2) + '.' },
              { seccion: 'Paso 4: el area',
                queHacemos: 'Multiplicamos los cuatro factores y sacamos la raiz.',
                paraQue: 'Tambien sale con &frac12; b c sen A, y debe dar lo mismo.',
                queda: 'A = ' + F.n(A, 2) + '&deg;,  area = ' + F.n(area, 2) + ' m&sup2;',
              ...
              { seccion: 'Paso 5: escribir',
                ...
                paraQue: 'Ojo con las unidades: el angulo en grados y el area en m&sup2;.',
                queda: 'A = ' + F.n(A, 2) + '&deg;,  area = ' + F.n(area, 2) + ' m&sup2;',
