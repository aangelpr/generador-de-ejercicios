      ...
      guia: G({
        ...
        pasos: [
          { rotulo: 'El denominador',
            seccion: 'Paso 1: comprobar que se anula',
            queHacemos: 'Evaluamos el denominador en ese punto.',
            paraQue: 'Dividir entre algo que tiende a 0 dispara la fraccion: hay una ASINTOTA VERTICAL ahi.',
            queda: 'se dispara;  falta ver hacia que lado',
          ...
          { rotulo: 'Signo del denominador',
            seccion: 'Paso 2: el signo por cada lado',
            queHacemos: 'Miramos si el denominador conserva el signo a ambos lados.',
            paraQue: 'Si esta al cuadrado nunca es negativo y los dos lados van al mismo sitio. Sin cuadrado, cambia de signo al cruzar.',
            queda: alCuadrado ? 'mismo signo por los dos lados' : 'signos contrarios por cada lado',
          ...
          { rotulo: 'Resultado',
            seccion: 'Paso 3: el resultado',
            queHacemos: 'Juntamos el signo del numerador con el del denominador.',
            paraQue: 'Si los dos laterales dan infinitos de signo contrario, el limite NO existe.',
            queda: ['+&infin;', '&minus;&infin;', 'no existe'][idx],
      ...
      guia: G({
        ...
        pasos: [
          { rotulo: 'Que exige la continuidad',
            seccion: 'Paso 1: que exige la continuidad',
            queHacemos: 'Recordamos que los dos trozos tienen que juntarse.',
            paraQue: 'Continua significa que se puede dibujar sin levantar el lapiz. Si un trozo llega a una altura y el otro empieza en otra, queda un escalon.',
            queda: 'trozo izquierdo = trozo derecho en x = ' + c,
          ...
          { rotulo: 'Valor por la derecha',
            seccion: 'Paso 2: el lado que ya esta fijo',
            queHacemos: 'Evaluamos el trozo que no tiene incognita.',
            paraQue: 'Ese lado ya esta decidido. La m del otro lado tiene que alcanzarlo.',
            queda: 'hay que llegar a ' + valorDerecha,
          ...
          { rotulo: 'La ecuacion',
            seccion: 'Paso 3: plantear la ecuacion',
            queHacemos: 'Igualamos los dos trozos y despejamos.',
            paraQue: 'Queda una ecuacion de primer grado con m como incognita.',
            queda: c + 'm = ' + (valorDerecha - bIzq),
          ...
          { rotulo: 'Valor de m',
            seccion: 'Paso 4: despejar m',
            queHacemos: 'Dividimos para dejar la m sola.',
            paraQue: 'Con esa m los dos trozos se tocan y la grafica queda de una sola pieza.',
            queda: 'm = ' + m,
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Se puede sustituir',
                seccion: 'Paso 1: por que se puede sustituir',
                queHacemos: 'Comprobamos que no hay nada que pueda romperse.',
                paraQue: 'Un polinomio no tiene denominadores ni raices: se puede sustituir y ya. Por eso este es el caso facil.',
                queda: 'sustituir x = ' + a,
              ...
              { rotulo: '(' + a + ')&sup2;',
                ...
                queHacemos: 'Elevamos al cuadrado, con parentesis.',
                paraQue: 'Primero las potencias. Los parentesis evitan el error de signo.',
                queda: p[0] + '(' + (a * a) + ') + ' + p[1] + '(' + a + ') + ' + p[2],
              ...
              { rotulo: 'Termino en x&sup2;',
                seccion: 'Paso 3: los productos',
                queHacemos: 'Multiplicamos la potencia por su coeficiente.',
                paraQue: 'Vamos pieza por pieza para no perder signos.',
                queda: (p[0] * a * a) + ' + ? + ' + p[2],
              ...
              { rotulo: 'Termino en x',
                seccion: 'Paso 3: los productos',
                queHacemos: 'Ahora el termino lineal.',
                paraQue: 'Ya quedan los tres numeros listos para sumar.',
                queda: (p[0] * a * a) + ' + (' + (p[1] * a) + ') + ' + p[2],
              ...
              { rotulo: 'Limite',
                ...
                paraQue: 'En un polinomio el limite es exactamente el valor de la funcion ahi.',
                queda: 'limite = ' + val,
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Denominador en x = ' + a,
                seccion: 'Paso 1: revisar el denominador',
                queHacemos: 'Miramos primero si el denominador se anula.',
                paraQue: 'Es lo unico que puede fallar en una fraccion. Si no se anula, todo lo demas es sustituir.',
                queda: 'denominador = ' + P.evalua(den, a) + ' (distinto de 0)',
              ...
              { rotulo: 'Entonces se sustituye',
                seccion: 'Paso 2: decidir el camino',
                queHacemos: 'Como no hay problema, sustituimos directo.',
                paraQue: 'No hace falta factorizar ni nada: solo se complica cuando sale 0/0.',
                queda: '? &divide; ' + P.evalua(den, a),
              ...
              { rotulo: 'Numerador',
                ...
                queHacemos: 'Evaluamos el de arriba.',
                paraQue: 'Ya con las dos partes se hace la division.',
                queda: P.evalua(num, a) + ' &divide; ' + P.evalua(den, a),
                ...
                despues: '' },
              { rotulo: 'Limite',
                seccion: 'Paso 4: dividir',
                queHacemos: 'Hacemos la division.',
                paraQue: 'Ese es el limite.',
                queda: 'limite = ' + F.n(P.evalua(num, a) / P.evalua(den, a), 4),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Sustituir primero',
                ...
                queHacemos: 'Sustituimos de una vez para ver que pasa.',
                paraQue: 'Siempre se prueba primero: a veces no hay ningun problema y se acaba ahi.',
                queda: '0/0:  hay que trabajarlo',
              ...
              { rotulo: 'Que significa 0/0',
                seccion: 'Paso 2: que significa 0/0',
                queHacemos: 'Interpretamos la indeterminacion.',
                paraQue: '0/0 NO quiere decir que el limite no exista: quiere decir que arriba y abajo comparten un factor que se puede cancelar.',
                queda: 'hay un factor comun escondido',
              ...
              { rotulo: 'Factorizar arriba',
                seccion: 'Paso 3: factorizar',
                queHacemos: 'Sacamos la raiz para armar la diferencia de cuadrados.',
                paraQue: 'a&sup2; &minus; b&sup2; = (a + b)(a &minus; b). Asi aparece el factor que se cancela.',
                queda: F.frac('(x + ' + a + ')(x &minus; ' + a + ')', 'x &minus; ' + a),
              ...
              { rotulo: 'Cancelar',
                seccion: 'Paso 4: cancelar',
                queHacemos: 'Cancelamos el factor repetido.',
                paraQue: 'Se puede cancelar porque x se ACERCA a ' + a + ' pero nunca vale ' + a + ': el factor nunca es exactamente 0.',
                queda: 'x + ' + a,
              ...
              { rotulo: 'Limite',
                seccion: 'Paso 5: sustituir',
                queHacemos: 'Volvemos a sustituir, ya sin el factor problematico.',
                paraQue: 'Ahora si funciona.',
                queda: 'limite = ' + (2 * a),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Grado de arriba',
                seccion: 'Paso 1: el grado de arriba',
                queHacemos: 'Localizamos el exponente mas grande de arriba.',
                paraQue: 'Cuando x se hace gigante, de cada polinomio SOLO importa su termino de mayor grado: los demas se vuelven insignificantes.',
                queda: 'grado arriba ' + gn + ',  grado abajo ?',
              ...
              { rotulo: 'Grado de abajo',
                seccion: 'Paso 1: el grado de abajo',
                queHacemos: 'Ahora el de abajo.',
                paraQue: 'Es una carrera entre los dos: gana el que crezca mas rapido.',
                queda: 'grado arriba ' + gn + ',  grado abajo ' + gd,
              ...
              { rotulo: 'Quien crece mas',
                seccion: 'Paso 2: quien gana',
                queHacemos: 'Comparamos los dos grados.',
                paraQue: 'Gana abajo: el limite es 0. Gana arriba: se va a infinito. Empate: el cociente de los coeficientes principales.',
                queda: gn === gd ? 'empate' : (gn < gd ? 'gana el denominador' : 'gana el numerador'),
              ...
              (val === null
                ? { rotulo: 'Limite',
                  seccion: 'Paso 3: el resultado',
                  queHacemos: 'Damos el limite.',
                  paraQue: 'El numerador domina: la fraccion crece sin parar y no se estaciona en ningun numero.',
                  queda: 'no existe un valor finito',
                ...
                : { rotulo: 'Limite',
                  seccion: 'Paso 3: el resultado',
                  queHacemos: 'Damos el limite.',
                  paraQue: gn < gd ? 'El denominador aplasta al numerador, asi que la fraccion se hace diminuta.' : 'Con grados iguales sobrevive solo la proporcion entre los coeficientes principales.',
                  queda: 'limite = ' + F.n(val, 4),
        ...
        if (t2 === 'conjugado') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Sustituir primero',
                seccion: 'Paso 1: probar sustituyendo',
                queHacemos: 'Sustituimos de una vez.',
                paraQue: 'Sale 0/0, pero aqui no se puede factorizar: estorba la raiz.',
                queda: '0/0;  hay que quitar la raiz',
              ...
              { rotulo: 'Por que el conjugado',
                seccion: 'Paso 2: multiplicar por el conjugado',
                queHacemos: 'Multiplicamos arriba y abajo por el conjugado.',
                paraQue: 'Al multiplicar (a &minus; b)(a + b) sale a&sup2; &minus; b&sup2;, y eso hace desaparecer la raiz de arriba.',
                queda: F.frac('(x + ' + a + ') &minus; ' + a, 'x(&radic;<span class="rad">x + ' + a + '</span> + ' + rz + ')'),
              ...
              { rotulo: 'Numerador',
                seccion: 'Paso 3: simplificar arriba',
                queHacemos: 'Hacemos la resta de arriba.',
                paraQue: 'Los numeros se cancelan y queda solo la x, que es justo lo que hay abajo.',
                queda: F.frac('x', 'x(&radic;<span class="rad">x + ' + a + '</span> + ' + rz + ')'),
              ...
              { rotulo: 'Cancelar',
                seccion: 'Paso 4: cancelar',
                queHacemos: 'Cancelamos la x.',
                paraQue: 'Ya sin la x en el denominador, la sustitucion funciona.',
                queda: F.frac(1, '&radic;<span class="rad">x + ' + a + '</span> + ' + rz),
              ...
              { rotulo: 'Limite',
                seccion: 'Paso 5: sustituir',
                queHacemos: 'Sustituimos x = 0.',
                paraQue: 'Comprobacion: siempre sale 1/(2&radic;a), que es la derivada de la raiz en ese punto.',
                queda: 'limite = ' + F.n(val, 4),
          ...
          var pasosTr = [
            { rotulo: 'El limite clave',
              seccion: 'Paso 1: el limite clave',
              queHacemos: 'Recordamos el unico limite que hay que memorizar.',
              paraQue: 'Con trigonometricas no se puede factorizar ni usar el conjugado. La herramienta es acomodar hasta que aparezca sen(u)/u.',
              queda: 'hay que hacer aparecer sen(u)/u',
          ...
          if (tipo === 'senEntreX') {
            pasosTr.push({
              ...
              seccion: 'Paso 2: acomodar el denominador',
              queHacemos: 'Vemos por cuanto hay que multiplicar abajo para que aparezca el mismo argumento.',
              paraQue: 'La formula pide sen(u)/u con la MISMA u arriba y abajo. Hay que multiplicar tambien arriba, para no cambiar el valor.',
            ...
            pasosTr.push({
              rotulo: 'Limite',
              seccion: 'Paso 3: el resultado',
              queHacemos: 'Sustituimos la fraccion por 1.',
              paraQue: 'Solo sobrevive el numero que sacamos fuera.',
              queda: 'limite = ' + val,
            ...
            pasosTr.push({
              ...
              seccion: 'Paso 2: acomodar los dos senos',
              queHacemos: 'Reescribimos para que cada seno tenga su propio argumento debajo.',
              paraQue: 'Asi las dos primeras fracciones tienden a 1 y solo sobrevive la tercera.',
              queda: '1 &middot; 1 &middot; ' + F.frac(k, m),
            ...
            pasosTr.push({
              rotulo: 'Limite',
              seccion: 'Paso 3: el resultado',
              queHacemos: 'Calculamos lo que queda.',
              paraQue: 'Ese cociente de los dos argumentos es todo el limite.',
              queda: 'limite = ' + F.n(val, 4),
            ...
            pasosTr.push({
              ...
              seccion: 'Paso 2: abrir la tangente',
              queHacemos: 'Escribimos la tangente como seno entre coseno.',
              paraQue: 'Asi aparece el seno que necesitamos para usar el limite clave.',
              queda: k + ' &middot; ' + F.frac('sen(' + k + 'x)', k + 'x') + ' &middot; ' + F.frac(1, 'cos(' + k + 'x)'),
            ...
            pasosTr.push({
              ...
              queHacemos: 'Miramos a cuanto tiende el coseno.',
              paraQue: 'cos(0) = 1, asi que ese factor desaparece y queda igual que el caso del seno.',
              queda: k + ' &middot; 1 &middot; 1',
            ...
            pasosTr.push({
              rotulo: 'Limite',
              seccion: 'Paso 4: el resultado',
              queHacemos: 'Multiplicamos lo que queda.',
              paraQue: 'Atajo util: tan(ax)/x con x&rarr;0 tiende a a, igual que el seno.',
              queda: 'limite = ' + val,
              pregunta: '&iquest;Cuanto vale el limite?',
              resp: R.numero(val, { dec: 4, tol: 0.001 }),
            ...
            pasosTr.push({
              rotulo: 'Conjugado',
              seccion: 'Paso 2: hacer aparecer el seno',
              queHacemos: 'Multiplicamos por el conjugado del numerador.',
              paraQue: 'De sen&sup2; + cos&sup2; = 1 se despeja 1 &minus; cos&sup2; = sen&sup2;. Asi aparecen los senos.',
              queda: k + ' &middot; ' + F.frac('sen(' + k + 'x)', k + 'x') + ' &middot; ' + F.frac('sen(' + k + 'x)', '1 + cos(' + k + 'x)'),
            ...
            pasosTr.push({
              ...
              seccion: 'Paso 3: la segunda fraccion',
              queHacemos: 'Evaluamos la segunda fraccion.',
              paraQue: 'Arriba sen(0) = 0 y abajo 1 + cos(0) = 2. Queda 0/2, o sea 0.',
              queda: k + ' &middot; 1 &middot; 0',
            ...
            pasosTr.push({
              ...
              seccion: 'Paso 4: el resultado',
              queHacemos: 'Multiplicamos lo que queda.',
              paraQue: 'Este es el otro limite que conviene memorizar: (1 &minus; cos u)/u tiende a 0.',
              queda: 'limite = ' + val,
              pregunta: '&iquest;Cuanto vale el limite?',
              resp: R.numero(val, { dec: 4, tol: 0.001 }),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Que regla por la izquierda',
                seccion: 'Paso 1: que regla por la izquierda',
                queHacemos: 'Decidimos que tramo manda al acercarse por la izquierda.',
                paraQue: 'Por la izquierda significa valores MENORES, y esa es justo la condicion del primer tramo.',
              ...
              { rotulo: 'Limite izquierdo',
                seccion: 'Paso 2: el limite izquierdo',
                queHacemos: 'Evaluamos con la regla de la izquierda.',
                paraQue: 'Ese es el valor al que se acerca la funcion viniendo por ese lado.',
                queda: 'izquierda ' + izq + ',  derecha ?',
              ...
              { rotulo: 'Limite derecho',
                seccion: 'Paso 3: el limite derecho',
                queHacemos: 'Ahora con la regla del otro tramo.',
                paraQue: 'Cada lado usa la regla de SU tramo.',
                queda: 'izquierda ' + izq + ',  derecha ' + der,
              ...
              { rotulo: '&iquest;Existe?',
                seccion: 'Paso 4: comparar',
                queHacemos: 'Comparamos los dos laterales.',
                paraQue: 'El limite existe SOLO si los dos coinciden. Si no, la grafica tiene un salto ahi.',
                queda: existe ? 'coinciden: el limite existe y vale ' + izq : 'no coinciden: el limite no existe',
              ...
              { rotulo: 'Respuesta',
                ...
                queHacemos: 'Damos los dos laterales y la conclusion.',
                paraQue: 'Para cerrar el ejercicio.',
                queda: 'izquierda ' + izq + ',  derecha ' + der + ',  ' + (existe ? 'si existe' : 'no existe'),
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { rotulo: 'Sustituir primero',
                seccion: 'Paso 1: probar sustituyendo',
                queHacemos: 'Sustituimos de una vez.',
                paraQue: 'Otro 0/0: hay un factor comun escondido y toca factorizar el de arriba.',
                queda: '0/0;  factorizar arriba',
              ...
              { rotulo: 'Encontrar b',
                seccion: 'Paso 2: encontrar b',
                queHacemos: 'Buscamos de que numero es cubo el termino que resta.',
                paraQue: 'a&sup3; &minus; b&sup3; = (a &minus; b)(a&sup2; + ab + b&sup2;): de ahi sale el factor que se cancela.',
                queda: '(x ' + (a > 0 ? '&minus; ' + a : '+ ' + (-a)) + ')(x&sup2; + ?x + ?)',
              ...
              { rotulo: 'El trinomio',
                ...
                queHacemos: 'Ponemos el coeficiente de en medio.',
                paraQue: 'Ojo al signo: en la diferencia de cubos el trinomio va TODO sumando.',
                queda: '(x ' + (a > 0 ? '&minus; ' + a : '+ ' + (-a)) + ')(x&sup2; + ' + a + 'x + ' + (a * a) + ')',
              ...
              { rotulo: 'Cancelar y sustituir',
                seccion: 'Paso 4: cancelar y sustituir',
                queHacemos: 'Cancelamos y sustituimos en el trinomio.',
                paraQue: 'Curiosidad: siempre sale 3a&sup2;, que es la derivada de x&sup3; en ese punto. No es casualidad.',
                queda: 'limite = ' + val,
