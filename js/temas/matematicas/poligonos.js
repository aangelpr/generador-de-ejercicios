  ...
  extra.anguloCentral = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: de que angulo hablamos',
            queHacemos: 'Distinguimos el angulo central del interior.',
            paraQue: 'El interior esta en la esquina; el central, en el centro. Confundirlos cambia toda la cuenta.',
            queda: 'angulo central = 360&deg; &divide; (rebanadas)',
          ...
          { seccion: 'Paso 2: cuantas rebanadas',
            queHacemos: 'Contamos en cuantas rebanadas queda partido el poligono.',
            paraQue: 'Una por cada lado, y todas iguales porque es regular.',
            queda: '360&deg; &divide; ' + p.n,
          ...
          { seccion: 'Paso 3: repartir la vuelta',
            queHacemos: 'Repartimos los 360&deg; entre todas las rebanadas.',
            paraQue: 'Dato util: el angulo central y el EXTERIOR de un poligono regular miden lo mismo.',
            queda: F.n(360 / p.n, 2) + '&deg;',
  ...
  extra.areaRegular = function (r) {
    ...
    return {
      guia: G({
        ...
        pasos: [
          { seccion: 'Paso 1: el perimetro',
            queHacemos: 'Multiplicamos el numero de lados por lo que mide cada uno.',
            paraQue: 'El perimetro es el borde completo, y la formula del area lo necesita.',
            queda: 'perimetro = ' + perimetro + ' cm',
          ...
          { seccion: 'Paso 2: que es la apotema',
            queHacemos: 'Nos aseguramos de que dato nos dieron.',
            paraQue: 'La apotema llega al PUNTO MEDIO de un lado; al vertice llega el radio, que es mayor. Confundirlos es el error mas comun aqui.',
            queda: 'perimetro = ' + perimetro + ' cm,  apotema = ' + F.n(apotema, 2) + ' cm',
          ...
          { seccion: 'Paso 3: el area',
            queHacemos: 'Multiplicamos perimetro por apotema y dividimos entre 2.',
            paraQue: 'Es sumar los ' + p.n + ' triangulos que salen del centro: base = lado, altura = apotema.',
            queda: 'area = ' + F.n(perimetro * F.redondea(apotema, 2) / 2, 2) + ' cm&sup2;',
          ...
          { seccion: 'Paso 4: escribir',
            ...
            paraQue: 'Ojo con las unidades: el perimetro va en cm y el area en cm&sup2;.',
            queda: 'perimetro ' + perimetro + ' cm,  area ' + F.n(perimetro * F.redondea(apotema, 2) / 2, 2) + ' cm&sup2;',
      ...
      if (dif === 'facil') {
        ...
        if (tf === 'nombre') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: el prefijo',
                queHacemos: 'Buscamos el prefijo griego que significa ese numero.',
                paraQue: 'Los nombres no son inventados. Con los prefijos aprendidos ya no hay lista que memorizar.',
                queda: p.pre + '- + (terminacion)',
                pregunta: '&iquest;Que prefijo griego significa ' + p.n + '?',
                resp: R.opcion([p.pre + '-', otroP.pre + '-'], 0),
                pista: PREFIJOS,
                despues: 'El prefijo es <b>' + p.pre + '</b>.' },
              { seccion: 'Paso 2: pegar la terminacion',
                queHacemos: 'Le pegamos la terminacion al prefijo.',
                paraQue: '"-gono" significa angulo. El triangulo y el cuadrilatero son las dos excepciones.',
                queda: p.nombre,
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: partir la palabra',
                queHacemos: 'Le quitamos la terminacion al nombre.',
                paraQue: 'Lo que queda es el prefijo, y ahi esta escondido el numero.',
                queda: 'prefijo: ' + p.nombre.replace(/gono$|latero$|gulo$/, ''),
              ...
              { seccion: 'Paso 2: traducir el prefijo',
                queHacemos: 'Traducimos el prefijo a numero.',
                paraQue: 'Un poligono tiene tantos lados como angulos: la respuesta sirve para las dos cosas.',
                queda: p.n + ' lados',
        ...
        if (t === 'suma') {
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: partirlo en triangulos',
                queHacemos: 'Contamos en cuantos triangulos queda partido.',
                paraQue: 'De aqui sale el (n &minus; 2) de la formula: al vertice propio y a sus dos vecinos no se les traza diagonal.',
                queda: (p.n - 2) + ' triangulos',
              ...
              { seccion: 'Paso 2: la suma total',
                queHacemos: 'Multiplicamos los triangulos por 180&deg;.',
                paraQue: 'Esa es la suma de TODOS los angulos interiores, regular o no.',
                queda: 'suma = ' + ((p.n - 2) * 180) + '&deg;',
                ...
                despues: '' },
              { seccion: 'Paso 3: por que se puede repartir',
                queHacemos: 'Comprobamos que el poligono sea regular antes de dividir.',
                paraQue: 'Si no fuera regular, la suma seria la misma pero cada angulo podria ser distinto. La palabra "regular" del enunciado es la que autoriza este paso.',
                queda: ((p.n - 2) * 180) + '&deg; &divide; ' + p.n,
              ...
              { seccion: 'Paso 4: repartir',
                queHacemos: 'Dividimos la suma entre el numero de angulos.',
                paraQue: 'Comprobacion: en un poligono convexo cada interior debe salir menor que 180&deg;.',
                queda: 'cada interior = ' + F.n((p.n - 2) * 180 / p.n, 2) + '&deg;',
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: de donde sale el (n &minus; 3)',
                queHacemos: 'Contamos a cuantos vertices NO se les puede trazar diagonal.',
                paraQue: 'A si mismo y a sus dos vecinos: con los vecinos ya hay lado, no diagonal. Por eso son 3.',
                queda: 'de cada vertice salen ' + (p.n - 3),
              ...
              { seccion: 'Paso 2: multiplicar por los vertices',
                queHacemos: 'Multiplicamos por el numero de vertices.',
                paraQue: 'Este numero sale inflado a proposito; en el siguiente paso se corrige.',
                queda: (p.n * (p.n - 3)) + '  (inflado al doble)',
              ...
              { seccion: 'Paso 3: por que se divide entre 2',
                queHacemos: 'Vemos que cada diagonal se conto dos veces.',
                paraQue: 'La diagonal de A a C es la MISMA que la de C a A, pero la contamos en los dos vertices.',
                queda: (p.n * (p.n - 3)) + ' &divide; 2',
              ...
              { seccion: 'Paso 4: dividir',
                queHacemos: 'Partimos el resultado a la mitad.',
                paraQue: 'Comprobacion: un triangulo debe dar 0 diagonales.',
                queda: (p.n * (p.n - 3) / 2) + ' diagonales',
        ...
        if (t2 === 'desdeSuma') {
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: quitar el 180',
                queHacemos: 'Pasamos el 180 dividiendo al otro lado.',
                paraQue: 'Es la misma formula de siempre, solo que ahora la incognita es n. Siempre da exacto, porque la suma es multiplo de 180.',
                queda: 'n &minus; 2 = ' + (p.n - 2),
              ...
              { seccion: 'Paso 2: despejar n',
                queHacemos: 'Le sumamos 2 para llegar a n.',
                paraQue: 'Lo anterior era (n &minus; 2), no n. Quedarse ahi es el error tipico.',
                queda: 'n = ' + p.n,
              ...
              { seccion: 'Paso 3: el nombre',
                queHacemos: 'Traducimos el numero a nombre con el prefijo griego.',
                paraQue: 'La pregunta pide las dos cosas: cuantos lados y como se llama.',
                queda: p.n + ' lados,  ' + p.nombre,
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: pasar al exterior',
                queHacemos: 'Restamos el interior a 180&deg; para tener el exterior.',
                paraQue: 'Despejar n de (n &minus; 2)180/n es feo. Por el exterior sale en dos cuentas.',
                queda: 'exterior = ' + (180 - ang) + '&deg;',
              ...
              { seccion: 'Paso 2: el dato clave',
                queHacemos: 'Recordamos cuanto suman siempre los exteriores.',
                paraQue: 'Siempre 360&deg;, tenga 3 lados o 100. Es como dar una vuelta completa caminando por el borde.',
                queda: 'n = 360 &divide; ' + (180 - ang),
              ...
              { seccion: 'Paso 3: contar cuantos caben',
                queHacemos: 'Dividimos 360&deg; entre el angulo exterior.',
                paraQue: 'Debe dar un entero: si sale con decimales, algo se hizo mal.',
                queda: 'n = ' + p.n,
                ...
                despues: '' },
              { seccion: 'Paso 4: el nombre',
                queHacemos: 'Traducimos el numero a nombre.',
                paraQue: 'La pregunta pide las dos cosas.',
                queda: p.n + ' lados,  ' + p.nombre,
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: quitar la fraccion',
                queHacemos: 'Multiplicamos los dos lados por 2.',
                paraQue: 'Lo que divide de un lado pasa multiplicando al otro. Asi la ecuacion queda limpia.',
                queda: 'n(n &minus; 3) = ' + (2 * D),
              ...
              { seccion: 'Paso 2: encontrar n',
                queHacemos: 'Buscamos dos numeros que se lleven 3 y den ese producto.',
                paraQue: 'Se podria usar la formula general con n&sup2; &minus; 3n &minus; ' + (2 * D) + ' = 0, pero con numeros chicos esto es mas rapido.',
                queda: 'n = ' + p.n,
              ...
              { seccion: 'Paso 3: descartar la otra raiz',
                queHacemos: 'Tiramos la solucion negativa.',
                paraQue: 'Es un problema de geometria: un poligono no puede tener lados negativos.',
                queda: 'n = ' + p.n,
              ...
              { seccion: 'Paso 4: comprobar',
                queHacemos: 'Metemos el resultado en la formula original.',
                paraQue: 'Si vuelve a dar el numero del enunciado, la respuesta esta bien.',
                queda: p.n + ' lados  &check;',
          ...
          guiaDelPaso = G({
            ...
            pasos: [
              { seccion: 'Paso 1: la suma de los exteriores',
                queHacemos: 'Recordamos cuanto suman los exteriores.',
                paraQue: 'Siempre 360&deg;, sin importar los lados. Por eso este ejercicio es mas facil que el del interior.',
                queda: 'angulo exterior = 360&deg; &divide; (cuantos hay)',
              ...
              { seccion: 'Paso 2: cuantos hay',
                queHacemos: 'Contamos los angulos exteriores.',
                paraQue: 'Uno por vertice, y hay tantos vertices como lados.',
                queda: '360&deg; &divide; ' + p.n,
              ...
              { seccion: 'Paso 3: repartir',
                queHacemos: 'Dividimos 360&deg; entre el numero de angulos.',
                paraQue: 'Comprobacion: interior + exterior debe dar 180&deg;.',
                queda: F.n(360 / p.n, 2) + '&deg;',
